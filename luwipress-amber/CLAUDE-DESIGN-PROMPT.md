...
> You delivered the **LuwiPress Amber v1.1.0** Elementor Kit (Tapadum
...
Headline: **"LuwiPress Amber — World Instruments WooCommerce Theme"**
...
Output: a single PHP class (e.g., `LuwiPress_Amber_Customizer`)
...
`/releases/luwipress-amber-1.2.3.zip` — design tokens are unchanged
