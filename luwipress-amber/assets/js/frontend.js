/* LuwiPress Amber — frontend animation + interaction layer.
 *
...
(function () {
	...
	function setupTapPills() {
		...
		var tree = ( window.LuwiAmber && window.LuwiAmber.catTree ) || {};
	...
	function decorateBlogYouTubeEmbeds() {
		var BLOG_SCOPES = '.entry-content, .post-content, .luwipress-amber-single, article.post';
	...
	function buildMobileDrawer() {
		...
		var cfg = ( window.LuwiAmber && window.LuwiAmber.drawer ) || {};
		...
		// Atelier pick — pulled from window.LuwiAmber.drawer.pick if present,
