/* LuwiPress Amber — onboarding wizard front-end. */
(function ($) {
	'use strict';

	var ajaxurl  = LWP_AMBER_WIZARD.ajaxurl;
	var nonce    = LWP_AMBER_WIZARD.nonce;
	var i18n     = (LWP_AMBER_WIZARD_DATA && LWP_AMBER_WIZARD_DATA.i18n) || {};

	var $root  = $('.luwipress-amber-wizard');
	...
	$root.on('change', '#lwp-ai-toggle', function () {
		...
		$.post(ajaxurl, {
			action: 'luwipress_amber_wizard_step',
			step: 'ai_toggle',
			_ajax_nonce: nonce,
