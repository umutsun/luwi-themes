...
add_action( 'wp_enqueue_scripts', function () {
	...
	wp_localize_script( 'luwipress-amber-hero-search', 'LWP_HERO', array(
		...
		'i18n'       => array(
			...
			'adults'        => __( 'Adults', 'luwipress-amber' ),
			'children'      => __( 'Children', 'luwipress-amber' ),
			'adult'         => __( 'adult', 'luwipress-amber' ),
			'adultsWord'    => __( 'adults', 'luwipress-amber' ),
			'child'         => __( 'child', 'luwipress-amber' ),
			'childrenWord'  => __( 'children', 'luwipress-amber' ),
			'adultsAge'     => __( '12+ years', 'luwipress-amber' ),
			'childrenAge'   => __( '2–11 years', 'luwipress-amber' ),
