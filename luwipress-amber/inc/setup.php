...
add_action( 'after_setup_theme', function () {
	load_theme_textdomain( 'luwipress-amber', LUWIPRESS_AMBER_DIR . '/languages' );
	...
	register_nav_menus( [
		'primary'           => __( 'Primary navigation (header + drawer)', 'luwipress-amber' ),
		'mobile'            => __( 'Mobile drawer (header fallback)', 'luwipress-amber' ),
		'footer'            => __( 'Footer — Quick Links column', 'luwipress-amber' ),
		'footer-activities' => __( 'Footer — Explore column', 'luwipress-amber' ),
		'footer-legal'      => __( 'Footer — bottom-bar legal links', 'luwipress-amber' ),
	] );

	// Image sizes used inside Elementor Kit JSONs.
	add_image_size( 'luwipress-amber-card', 600, 600, true );
	add_image_size( 'luwipress-amber-cat',  600, 660, true );
	add_image_size( 'luwipress-amber-hero', 1100, 1100, false );
	add_image_size( 'luwipress-amber-editorial',      900, 720, true );
	add_image_size( 'luwipress-amber-editorial-feat', 1100, 880, true );
}, 5 );
