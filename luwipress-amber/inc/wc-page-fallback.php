...
if ( ! function_exists( 'luwipress_amber_wc_page_fallback' ) ) {
	 ...
	 * @return string
	 */
	function luwipress_amber_wc_page_fallback( $content ) {
	...
	add_filter( 'the_content', 'luwipress_amber_wc_page_fallback', 999 );
}
