...
class LuwiPress_Amber_Widget_Countdown extends Widget_Base {

	public function get_name()        { return 'lwp-countdown'; }
	public function get_title()       { return __( 'Countdown Timer', 'luwipress-amber' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_target', [ 'label' => __( 'Target', 'luwipress-amber' ) ] );

		$this->add_control( 'target_date', [
			'label'       => __( 'Target date & time', 'luwipress-amber' ),
			'description' => __( 'Picked in your site timezone (WP general settings) and rendered live in the visitor\'s browser.', 'luwipress-amber' ),
			'type'        => Controls_Manager::DATE_TIME,
			'default'     => gmdate( 'Y-m-d H:i:s', strtotime( '+7 days' ) ),
		] );

		$this->add_control( 'show_units', [
			'label'       => __( 'Units to show', 'luwipress-amber' ),
			'type'        => Controls_Manager::SELECT,
			'default'     => 'dhms',
			'options'     => [
				'dhms' => __( 'Days · Hours · Minutes · Seconds', 'luwipress-amber' ),
				'dhm'  => __( 'Days · Hours · Minutes', 'luwipress-amber' ),
				'hms'  => __( 'Hours · Minutes · Seconds', 'luwipress-amber' ),
			],
		] );

		$this->add_control( 'lbl_days',    [ 'label' => __( 'Label — days', 'luwipress-amber' ),    'type' => Controls_Manager::TEXT, 'default' => __( 'Days', 'luwipress-amber' ) ] );
		$this->add_control( 'lbl_hours',   [ 'label' => __( 'Label — hours', 'luwipress-amber' ),   'type' => Controls_Manager::TEXT, 'default' => __( 'Hours', 'luwipress-amber' ) ] );
		$this->add_control( 'lbl_minutes', [ 'label' => __( 'Label — minutes', 'luwipress-amber' ), 'type' => Controls_Manager::TEXT, 'default' => __( 'Minutes', 'luwipress-amber' ) ] );
		$this->add_control( 'lbl_seconds', [ 'label' => __( 'Label — seconds', 'luwipress-amber' ), 'type' => Controls_Manager::TEXT, 'default' => __( 'Seconds', 'luwipress-amber' ) ] );

		$this->add_control( 'expired_msg', [
			'label'   => __( 'Post-expiry message', 'luwipress-amber' ),
			'type'    => Controls_Manager::TEXTAREA,
			'rows'    => 2,
			'default' => __( "It's live. Browse the sale →", 'luwipress-amber' ),
		] );
		$this->add_control( 'expired_url', [
			'label'   => __( 'Post-expiry button URL (optional)', 'luwipress-amber' ),
			'type'    => Controls_Manager::URL,
			'default' => [ 'url' => '' ],
		] );
		$this->add_control( 'expired_btn', [
			'label'   => __( 'Post-expiry button label (optional)', 'luwipress-amber' ),
		...
		$this->add_control( 'align', [
			...
			'type'    => Controls_Manager::SELECT,
			'default' => 'center',
			'options' => [ 'left' => __( 'Left', 'luwipress-amber' ), 'center' => __( 'Center', 'luwipress-amber' ), 'right' => __( 'Right', 'luwipress-amber' ) ],
		] );
		$this->end_controls_section();
	}
