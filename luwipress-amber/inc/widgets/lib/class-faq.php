...
class LuwiPress_Amber_Widget_FAQ extends Widget_Base {

	public function get_name()        { return 'lwp-faq'; }
	public function get_title()       { return __( 'FAQ Accordion', 'luwipress-amber' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_items', [ 'label' => __( 'Questions', 'luwipress-amber' ) ] );

		$rep = new Repeater();
		$rep->add_control( 'q', [ 'label' => __( 'Question', 'luwipress-amber' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$rep->add_control( 'a', [ 'label' => __( 'Answer', 'luwipress-amber' ), 'type' => Controls_Manager::WYSIWYG, 'default' => '' ] );
		$rep->add_control( 'open', [
			'label'        => __( 'Open by default', 'luwipress-amber' ),
		...
		$this->add_control( 'items', [
			...
			'default'     => [
				[ 'q' => __( 'How long does shipping take?', 'luwipress-amber' ),         'a' => __( 'Replace this answer with your real shipping timeline + carriers + insurance details.', 'luwipress-amber' ) ],
				[ 'q' => __( 'What is your return policy?', 'luwipress-amber' ),          'a' => __( 'Describe your return / refund policy here — common answers convert best.', 'luwipress-amber' ) ],
				[ 'q' => __( 'Do you ship worldwide?', 'luwipress-amber' ),               'a' => __( 'List the regions you ship to and any restrictions.', 'luwipress-amber' ) ],
				[ 'q' => __( 'How can I contact customer support?', 'luwipress-amber' ),  'a' => __( 'Add your support email, hours and average response time here.', 'luwipress-amber' ) ],
			],
		] );

		$this->add_control( 'output_schema', [
			'label'        => __( 'Output FAQPage schema (JSON-LD)', 'luwipress-amber' ),
			'description'  => __( 'Required for Google FAQ rich result. Disable if you already have FAQPage schema on the page via Rank Math / Yoast.', 'luwipress-amber' ),
			'type'         => Controls_Manager::SWITCHER,
			'return_value' => 'yes',
			'default'      => 'yes',
		] );
		...
		$this->add_control( 'allow_multiple', [
			'label'        => __( 'Allow multiple open at once', 'luwipress-amber' ),
			'type'         => Controls_Manager::SWITCHER,
			'return_value' => 'yes',
			'default'      => '',
		] );
