...
class LuwiPress_Amber_Widget_Footer_Brand extends Widget_Base {

	public function get_name()        { return 'lwp-footer-brand'; }
	public function get_title()       { return __( 'Footer Brand', 'luwipress-amber' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_logo', [ 'label' => __( 'Logo', 'luwipress-amber' ) ] );

		$this->add_control(
			'logo_image',
			[
				'label'   => __( 'Logo image (optional)', 'luwipress-amber' ),
				'description' => __( 'If set, replaces the text logo.', 'luwipress-amber' ),
		...
		$this->add_control(
			'logo_text',
			[
				'label'   => __( 'Logo text', 'luwipress-amber' ),
		...
		$this->add_control(
			'accent_index',
			[
				'label'   => __( 'Accent character position (0-indexed)', 'luwipress-amber' ),
				'description' => __( 'Which character to italicise + accent-tint. -1 = none.', 'luwipress-amber' ),
		...
		$this->add_control(
			'logo_url',
			[
				'label'   => __( 'Logo link', 'luwipress-amber' ),
		...
		/* Tagline */
		$this->start_controls_section( 'section_tag', [ 'label' => __( 'Tagline', 'luwipress-amber' ) ] );
		$this->add_control(
			'tagline',
			[
				'label'   => __( 'Tagline / description', 'luwipress-amber' ),
				'type'    => Controls_Manager::TEXTAREA,
				'rows'    => 3,
				'default' => __( 'A short brand line that explains what your store does and where you ship from.', 'luwipress-amber' ),
			]
		);
		$this->end_controls_section();

		/* Contact */
		$this->start_controls_section( 'section_contact', [ 'label' => __( 'Contact', 'luwipress-amber' ) ] );
		$this->add_control( 'phone',   [ 'label' => __( 'Phone', 'luwipress-amber' ),   'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$this->add_control( 'email',   [ 'label' => __( 'Email', 'luwipress-amber' ),   'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$this->add_control( 'address', [ 'label' => __( 'Address line', 'luwipress-amber' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$this->end_controls_section();

		/* Social */
		$this->start_controls_section( 'section_social', [ 'label' => __( 'Social icons', 'luwipress-amber' ) ] );

		$rep = new Repeater();
		$rep->add_control(
			'network',
			[
				'label'   => __( 'Network', 'luwipress-amber' ),
		...
		$rep->add_control(
			'url',
			[ 'label' => __( 'URL', 'luwipress-amber' ), 'type' => Controls_Manager::URL, 'default' => [ 'url' => '#' ] ]
		);

		$this->add_control(
			'socials',
			[
				'label'       => __( 'Social links', 'luwipress-amber' ),
		...
		$this->add_control(
			'logo_color',
			[
				'label'   => __( 'Logo color', 'luwipress-amber' ),
		...
		$this->add_control(
			'accent_color',
			[
				'label'   => __( 'Accent color', 'luwipress-amber' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#D4AF37',
		...
		$this->add_control(
			'text_color',
			[
				'label'   => __( 'Text color', 'luwipress-amber' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#a89d85',
