...
class LuwiPress_Amber_Widget_Footer_Column extends Widget_Base {

	public function get_name()        { return 'lwp-footer-column'; }
	public function get_title()       { return __( 'Footer Column', 'luwipress-amber' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Column', 'luwipress-amber' ) ] );
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Shop', 'luwipress-amber' ),
			]
		);

		$rep = new Repeater();
		$rep->add_control( 'label', [ 'label' => __( 'Label', 'luwipress-amber' ), 'type' => Controls_Manager::TEXT, 'default' => 'Link' ] );
		$rep->add_control( 'url',   [ 'label' => __( 'URL', 'luwipress-amber' ),   'type' => Controls_Manager::URL,  'default' => [ 'url' => '#' ] ] );
		$rep->add_control(
			'hot',
			[
				'label'        => __( 'Highlight (sale / promo)', 'luwipress-amber' ),
		...
		$this->add_control(
			'links',
			[
				'label'       => __( 'Links', 'luwipress-amber' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $rep->get_controls(),
				'title_field' => '{{{ label || "Link" }}}',
				'default'     => [
					[ 'label' => __( 'Link 1', 'luwipress-amber' ), 'url' => [ 'url' => '#' ] ],
					[ 'label' => __( 'Link 2', 'luwipress-amber' ), 'url' => [ 'url' => '#' ] ],
					[ 'label' => __( 'Link 3', 'luwipress-amber' ), 'url' => [ 'url' => '#' ] ],
				],
			]
		);
		...
		$this->add_control(
			'link_color',
			[
				'label'     => __( 'Link color', 'luwipress-amber' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#a89d85',
		...
		$this->add_control(
			'hot_color',
			[
				'label'     => __( 'Hot link color', 'luwipress-amber' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#D4AF37',
