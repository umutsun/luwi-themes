...
class LuwiPress_Amber_Widget_Hero extends Widget_Base {

	public function get_name()        { return 'lwp-hero'; }
	public function get_title()       { return __( 'Hero', 'luwipress-amber' ); }
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'split',
				'options' => [
					'split'      => __( 'Split (text + visual side-by-side)', 'luwipress-amber' ),
					'centered'   => __( 'Centered (headline above image)', 'luwipress-amber' ),
					'full-bleed' => __( 'Full-bleed (image cover + text overlay)', 'luwipress-amber' ),
				],
			]
		);
		...
		/* Content */
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Content', 'luwipress-amber' ) ] );
		$this->add_control(
			'eyebrow',
			[
				'label'   => __( 'Eyebrow', 'luwipress-amber' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Welcome · Worldwide shipping', 'luwipress-amber' ),
			]
		);
		$this->add_control(
			'headline',
			[
				...
				'rows'        => 3,
				'default'     => __( 'Your headline<br>in <em>two lines</em> with a <span class="underline">highlighted phrase</span>.', 'luwipress-amber' ),
				'description' => __( 'Use <em>…</em> for italic emphasis (gold) and <span class="underline">…</span> for the underline accent.', 'luwipress-amber' ),
			]
		);
		$this->add_control(
			'lead',
			[
				'label'   => __( 'Lead paragraph', 'luwipress-amber' ),
				'type'    => Controls_Manager::TEXTAREA,
				'rows'    => 3,
				'default' => __( 'A short paragraph explaining who you are and what you make. Replace this copy from the widget editor.', 'luwipress-amber' ),
			]
		);
		...
		$this->add_control(
			'cta_primary_label',
			[
				'label'   => __( 'Primary CTA — label', 'luwipress-amber' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Explore the collection', 'luwipress-amber' ),
			]
		);
		$this->add_control(
			'cta_primary_url',
			[
				'label'   => __( 'Primary CTA — URL', 'luwipress-amber' ),
		...
		$this->add_control(
			'cta_secondary_label',
			[
				'label'   => __( 'Secondary CTA — label', 'luwipress-amber' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Learn more', 'luwipress-amber' ),
			]
		);
		$this->add_control(
			'cta_secondary_url',
			[
				'label'   => __( 'Secondary CTA — URL', 'luwipress-amber' ),
				'type'    => Controls_Manager::URL,
				'default' => [ 'url' => '' ],
			]
		);
		...
		$this->add_control(
			'image',
			[
				'label'       => __( 'Visual', 'luwipress-amber' ),
				'type'        => Controls_Manager::MEDIA,
				'default'     => [ 'url' => '' ],
				'description' => __( 'Used in split + centered + full-bleed variants. Falls back to a gradient.', 'luwipress-amber' ),
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section( 'section_stats', [
			'label' => __( 'Stats', 'luwipress-amber' ),
			'condition' => [ 'variant' => [ 'split', 'centered' ] ],
		] );
		$this->add_control(
			'show_stats',
			[
				'label'   => __( 'Show stats row', 'luwipress-amber' ),
		...
		$repeater->add_control(
			'value',
			[ 'label' => __( 'Value', 'luwipress-amber' ), 'type' => Controls_Manager::TEXT, 'default' => '1,200+' ]
		);
		$repeater->add_control(
			'label',
			[ 'label' => __( 'Label', 'luwipress-amber' ), 'type' => Controls_Manager::TEXT, 'default' => 'Instruments' ]
		);
		$this->add_control(
			'stats',
			[
				'label'       => __( 'Stat cards', 'luwipress-amber' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $repeater->get_controls(),
				'title_field' => '{{{ value }}} — {{{ label }}}',
				'default'     => [
					[ 'value' => '1,200+', 'label' => __( 'Instruments', 'luwipress-amber' ) ],
					[ 'value' => '28',     'label' => __( 'Master makers', 'luwipress-amber' ) ],
					[ 'value' => '47',     'label' => __( 'Countries shipped', 'luwipress-amber' ) ],
				],
		...
		$this->start_controls_section( 'section_master', [
			'label'     => __( 'Master overlay', 'luwipress-amber' ),
			'condition' => [ 'variant' => [ 'split', 'full-bleed' ] ],
		] );
		$this->add_control(
			'master_avatar',
			[
				'label'       => __( 'Master avatar', 'luwipress-amber' ),
				'type'        => Controls_Manager::MEDIA,
				'default'     => [ 'url' => '' ],
				'description' => __( 'Square portrait — anything from 96×96 up. Empty to disable the overlay.', 'luwipress-amber' ),
			]
		);
		$this->add_control(
			'master_name',
			[
				'label'   => __( 'Master name', 'luwipress-amber' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Yıldırım Palabıyık', 'luwipress-amber' ),
			]
		);
		$this->add_control(
			'master_role',
			[
				'label'   => __( 'Master role', 'luwipress-amber' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Role · Location', 'luwipress-amber' ),
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			'overlay_color',
			[
				'label'     => __( 'Image overlay (full-bleed only)', 'luwipress-amber' ),
