...
class LuwiPress_Amber_Widget_Load_More extends Widget_Base {

	public function get_name()        { return 'lwp-load-more'; }
	public function get_title()       { return __( 'Load More', 'luwipress-amber' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Button', 'luwipress-amber' ) ] );

		$this->add_control(
			'mode',
			[
				'label'   => __( 'Mode', 'luwipress-amber' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'link',
				'options' => [
					'link' => __( 'Plain link (SEO-friendly)', 'luwipress-amber' ),
					'ajax' => __( 'AJAX (in-place append)', 'luwipress-amber' ),
				],
			]
		);
		$this->add_control(
			'label_template',
			[
				'label'   => __( 'Label', 'luwipress-amber' ),
				'description' => __( 'Use %d for remaining count placeholder.', 'luwipress-amber' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Load %d more posts', 'luwipress-amber' ),
			]
		);
		$this->add_control(
			'target_selector',
			[
				'label'   => __( 'Target container (AJAX mode)', 'luwipress-amber' ),
				'description' => __( 'Where to append new posts. Default catches WC / WP loops.', 'luwipress-amber' ),
				'type'    => Controls_Manager::TEXT,
		...
		$this->add_control(
			'hide_when_done',
			[
				'label'        => __( 'Hide when no more pages', 'luwipress-amber' ),
		...
		$this->add_control( 'text_color', [ 'label' => __( 'Text color', 'luwipress-amber' ), 'type' => Controls_Manager::COLOR, 'default' => '#1A1612',
			'selectors' => [ '{{WRAPPER}} .lwp-lm__btn' => 'color: {{VALUE}}; border-color: {{VALUE}};' ] ] );
		$this->add_control( 'bg_hover', [ 'label' => __( 'Hover background', 'luwipress-amber' ), 'type' => Controls_Manager::COLOR, 'default' => '#1A1612',
