...
class LuwiPress_Amber_Widget_Perks_List extends Widget_Base {

	public function get_name()        { return 'lwp-perks-list'; }
	public function get_title()       { return __( 'Perks List', 'luwipress-amber' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Perks', 'luwipress-amber' ) ] );

		$rep = new Repeater();
		$rep->add_control(
			'icon_type',
			[
				'label'   => __( 'Icon style', 'luwipress-amber' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'check',
				'options' => [
					'check'    => __( 'Check', 'luwipress-amber' ),
					'truck'    => __( 'Truck', 'luwipress-amber' ),
					'shield'   => __( 'Shield', 'luwipress-amber' ),
					'tool'     => __( 'Tool', 'luwipress-amber' ),
					'star'     => __( 'Star', 'luwipress-amber' ),
					'heart'    => __( 'Heart', 'luwipress-amber' ),
					'leaf'     => __( 'Leaf', 'luwipress-amber' ),
					'gift'     => __( 'Gift', 'luwipress-amber' ),
					'phone'    => __( 'Phone', 'luwipress-amber' ),
				],
			]
		);
		$rep->add_control( 'strong', [ 'label' => __( 'Bold lead', 'luwipress-amber' ), 'type' => Controls_Manager::TEXT, 'default' => 'Hand-tuned' ] );
		$rep->add_control( 'body',   [ 'label' => __( 'Body', 'luwipress-amber' ),     'type' => Controls_Manager::TEXT, 'default' => 'in our atelier before shipping' ] );

		$this->add_control(
			'perks',
			[
				'label'       => __( 'Perks', 'luwipress-amber' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $rep->get_controls(),
				'title_field' => '{{{ strong || "Perk" }}}',
				'default'     => [
					[ 'icon_type' => 'check',  'strong' => __( 'Hand-tuned', 'luwipress-amber' ),     'body' => __( 'in our atelier before shipping', 'luwipress-amber' ) ],
					[ 'icon_type' => 'truck',  'strong' => __( 'Free DHL shipping', 'luwipress-amber' ), 'body' => __( 'on orders over €450', 'luwipress-amber' ) ],
					[ 'icon_type' => 'shield', 'strong' => __( '2-year warranty', 'luwipress-amber' ), 'body' => __( '+ lifetime tuning support', 'luwipress-amber' ) ],
				],
			]
		);
		...
		$this->add_control( 'icon_color',   [ 'label' => __( 'Icon color', 'luwipress-amber' ),   'type' => Controls_Manager::COLOR, 'default' => '#9A7B3A',
			'selectors' => [ '{{WRAPPER}} .lwp-perks__icon' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'strong_color', [ 'label' => __( 'Bold color', 'luwipress-amber' ),   'type' => Controls_Manager::COLOR, 'default' => '#1A1612',
			'selectors' => [ '{{WRAPPER}} .lwp-perks__strong' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'body_color',   [ 'label' => __( 'Body color', 'luwipress-amber' ),   'type' => Controls_Manager::COLOR, 'default' => '#3a342c',
