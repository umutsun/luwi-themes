...
class LuwiPress_Amber_Widget_Pullquote extends Widget_Base {

	public function get_name()        { return 'lwp-pullquote'; }
	public function get_title()       { return __( 'Pullquote', 'luwipress-amber' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Quote', 'luwipress-amber' ) ] );

		$this->add_control(
			'quote',
			[
				'label'   => __( 'Quote text', 'luwipress-amber' ),
				'type'    => Controls_Manager::TEXTAREA,
				'rows'    => 4,
				'default' => __( 'A short, punchy quote that captures the essence of the piece in a single line.', 'luwipress-amber' ),
			]
		);
		$this->add_control(
			'attribution',
			[
				'label'   => __( 'Attribution (optional)', 'luwipress-amber' ),
		...
		$this->add_control(
			'citation_url',
			[
				'label'   => __( 'Citation URL (optional)', 'luwipress-amber' ),
		...
		$this->add_control(
			'show_mark',
			[
				'label'        => __( 'Show decorative quote mark', 'luwipress-amber' ),
		...
		$this->add_control( 'quote_color', [ 'label' => __( 'Quote color', 'luwipress-amber' ), 'type' => Controls_Manager::COLOR, 'default' => '#735c00',
			'selectors' => [ '{{WRAPPER}} .lwp-pq__text' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'mark_color', [ 'label' => __( 'Mark color', 'luwipress-amber' ), 'type' => Controls_Manager::COLOR, 'default' => 'rgba(155,123,58,0.2)',
			'selectors' => [ '{{WRAPPER}} .lwp-pq__mark' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'attr_color', [ 'label' => __( 'Attribution color', 'luwipress-amber' ), 'type' => Controls_Manager::COLOR, 'default' => '#8b7f6a',
