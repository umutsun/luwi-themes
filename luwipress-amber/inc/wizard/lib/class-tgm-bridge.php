 ...
 *
 * Required plugins for LuwiPress Amber:
...
class LuwiPress_Amber_TGM_Bridge {
	...
	public function manifest() {
		return [
			'elementor' => [
				...
				'wporg'    => 'elementor',
				'required' => true,
				'why'      => __( 'Page builder — required for the LuwiPress Amber templates.', 'luwipress-amber' ),
			],
			'elementskit-lite' => [
				...
				'required' => true,
				'why'      => __( 'Header builder + mega menu — bundled kit relies on this for the sticky header.', 'luwipress-amber' ),
			],
			'woocommerce' => [
				'name'     => 'WooCommerce',
				'slug'     => 'woocommerce',
				...
				'why'      => __( 'E-commerce backbone — required for the shop, single product, cart, checkout, and account templates.', 'luwipress-amber' ),
			],
		];
	}
