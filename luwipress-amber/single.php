			...
			<article <?php post_class( 'lwp-journal-article' ); ?>>
				...
				<div class="lwp-page-container">
					<nav class="lwp-crumb" aria-label="<?php esc_attr_e( 'Breadcrumb', 'luwipress-amber' ); ?>">
						...
						if ( $blog_id ) : ?>
							<span class="sep">›</span>
							<a href="<?php echo esc_url( get_permalink( $blog_id ) ); ?>"><?php echo esc_html( get_the_title( $blog_id ) ?: __( 'Journal', 'luwipress-amber' ) ); ?></a>
						<?php endif; ?>
						<span class="sep">›</span>
					...
					<header class="lwp-journal-head">
						...
						<div class="lwp-journal-meta">
							<span class="lwp-journal-meta__author"><?php
								...
								printf( esc_html__( 'By %s', 'luwipress-amber' ), esc_html( get_the_author_meta( 'display_name', $author_id ) ) );
							?></span>
							<span class="sep">·</span>
							...
							<span><?php
								...
								printf( esc_html( _n( '%d min read', '%d min read', $reading_time, 'luwipress-amber' ) ), $reading_time );
							?></span>
						</div>
					</header>
				</div>
				...
				<div class="lwp-page-container">
					...
					if ( $tags && ! is_wp_error( $tags ) ) : ?>
						<div class="lwp-journal-tags">
							<span class="lwp-journal-tags__label"><?php esc_html_e( 'Tagged', 'luwipress-amber' ); ?></span>
