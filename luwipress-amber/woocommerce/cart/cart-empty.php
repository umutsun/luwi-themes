 ...
 * DOM. Discovery rail moved out to a separate `luwipress_amber_after_cart_empty`
...
<section class="lwp-cart-empty" role="region" aria-label="<?php esc_attr_e( 'Empty cart', 'luwipress-amber' ); ?>">
	<div class="lwp-cart-empty__inner">
		...
		<h1 class="lwp-cart-empty__title"><?php
			echo wp_kses_post( apply_filters(
				'luwipress_amber_cart_empty_title',
				__( 'Your cart is empty', 'luwipress-amber' )
			) );
		?></h1>

		<p class="lwp-cart-empty__blurb"><?php
			echo esc_html( apply_filters(
				'luwipress_amber_cart_empty_blurb',
				__( 'Hand-picked instruments are waiting in the atelier. Browse the collection or pick up where you left off.', 'luwipress-amber' )
			) );
		?></p>

		<div class="lwp-cart-empty__actions">
			<a href="<?php echo esc_url( $shop_url ); ?>" class="lwp-cart-empty__cta lwp-cart-empty__cta--primary"><?php esc_html_e( 'Browse the collection', 'luwipress-amber' ); ?></a>
			<?php if ( $has_account ) : ?>
				<a href="<?php echo esc_url( $account_url ); ?>" class="lwp-cart-empty__cta lwp-cart-empty__cta--ghost"><?php esc_html_e( 'My orders', 'luwipress-amber' ); ?></a>
			<?php endif; ?>
		</div>
 ...
 */
do_action( 'luwipress_amber_after_cart_empty' );
