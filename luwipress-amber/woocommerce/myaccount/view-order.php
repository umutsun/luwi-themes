...
if ( ! $order ) {
	echo '<p>' . esc_html__( 'Invalid order.', 'luwipress-amber' ) . '</p>';
	return;
}
...
<h2>
	...
	printf( esc_html__( 'Order #%s', 'luwipress-amber' ), esc_html( $order->get_order_number() ) );
	?>
</h2>
<p class="lwp-acct-sub">
	...
	printf(
		esc_html__( 'Placed on %1$s · %2$s', 'luwipress-amber' ),
...
<?php if ( ! in_array( $status, [ 'cancelled', 'refunded', 'failed' ], true ) ) : ?>
	<div class="lwp-acct-card">
		<h3><?php esc_html_e( 'Tracking', 'luwipress-amber' ); ?></h3>
		<div class="lwp-track">
...
<div class="lwp-acct-card lwp-acct-card--flush">
	<h3 class="lwp-acct-card__head"><?php esc_html_e( 'Items', 'luwipress-amber' ); ?></h3>
...
<div class="lwp-acct-card">
	<h3><?php esc_html_e( 'Summary', 'luwipress-amber' ); ?></h3>
	...
	<?php if ( $order->get_customer_note() ) : ?>
		<p class="lwp-order-note" style="margin-top:18px;padding-top:18px;border-top:1px solid var(--line);font-size:13.5px;color:var(--ink-soft);">
			<strong style="font-family:var(--mono,monospace);font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:var(--muted);display:block;margin-bottom:6px;"><?php esc_html_e( 'Note', 'luwipress-amber' ); ?></strong>
...
if ( $show_billing || $show_shipping ) : ?>
	<div class="lwp-acct-card">
		<h3><?php esc_html_e( 'Addresses', 'luwipress-amber' ); ?></h3>
		<div class="lwp-addr-grid">
			<?php if ( $show_billing ) : ?>
				<div class="lwp-addr-card">
					<span class="lwp-addr-card__lbl"><?php esc_html_e( 'Billing', 'luwipress-amber' ); ?></span>
			...
			<?php if ( $show_shipping ) : ?>
				<div class="lwp-addr-card">
					<span class="lwp-addr-card__lbl"><?php esc_html_e( 'Shipping', 'luwipress-amber' ); ?></span>
