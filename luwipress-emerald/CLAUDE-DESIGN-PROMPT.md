...
> You delivered the **LuwiPress Emerald v1.1.0** Elementor Kit (Tapadum
...
Headline: **"LuwiPress Emerald — World Instruments WooCommerce Theme"**
...
Output: a single PHP class (e.g., `LuwiPress_Emerald_Customizer`)
...
`/releases/luwipress-emerald-1.2.3.zip` — design tokens are unchanged
