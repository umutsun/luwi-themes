/**
 * LuwiPress Emerald — Shop archive Load More
 *
 * Activates when the operator toggles `luwipress_emerald_shop_loadmore` on.
...
( function () {
	'use strict';
	if ( typeof window.LWP_EMERALD_LM === 'undefined' ) { return; }
	var cfg = window.LWP_EMERALD_LM;
