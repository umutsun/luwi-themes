/* LuwiPress Emerald — onboarding wizard front-end. */
(function ($) {
	'use strict';

	var ajaxurl  = LWP_EMERALD_WIZARD.ajaxurl;
	var nonce    = LWP_EMERALD_WIZARD.nonce;
	var i18n     = (LWP_EMERALD_WIZARD_DATA && LWP_EMERALD_WIZARD_DATA.i18n) || {};

	var $root  = $('.luwipress-emerald-wizard');
	...
	$root.on('change', '#lwp-ai-toggle', function () {
		...
		$.post(ajaxurl, {
			action: 'luwipress_emerald_wizard_step',
			step: 'ai_toggle',
			_ajax_nonce: nonce,
