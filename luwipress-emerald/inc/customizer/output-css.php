...
add_action( 'wp_enqueue_scripts', function () {
	if ( ! wp_style_is( 'luwipress-emerald-tokens', 'enqueued' ) ) return;
	wp_add_inline_style( 'luwipress-emerald-tokens', luwipress_emerald_inline_token_overrides() );
}, 30 );

// Also inject into the block editor preview.
add_action( 'enqueue_block_editor_assets', function () {
	if ( ! wp_style_is( 'luwipress-emerald-editor-tokens', 'enqueued' ) ) return;
	wp_add_inline_style( 'luwipress-emerald-editor-tokens', luwipress_emerald_inline_token_overrides() );
} );

/**
 * Compose the :root override block.
 */
function luwipress_emerald_inline_token_overrides() {
	$mods = [
		'primary'       => get_theme_mod( 'luwipress_emerald_color_primary' ),
		'primary-hover' => get_theme_mod( 'luwipress_emerald_color_primary_hover' ),
		'primary-soft'  => get_theme_mod( 'luwipress_emerald_color_primary_soft' ),
		'accent'        => get_theme_mod( 'luwipress_emerald_color_accent' ),
		'sale'          => get_theme_mod( 'luwipress_emerald_color_sale' ),
		'success'       => get_theme_mod( 'luwipress_emerald_color_success' ),
		'ink'           => get_theme_mod( 'luwipress_emerald_color_ink' ),
		'bg'            => get_theme_mod( 'luwipress_emerald_color_bg' ),
		'bg-alt'        => get_theme_mod( 'luwipress_emerald_color_bg_alt' ),
		'black'         => get_theme_mod( 'luwipress_emerald_color_black' ),
	];
