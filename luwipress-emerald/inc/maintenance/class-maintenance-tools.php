 ...
 *
 *   - LuwiPress_Emerald_Slug_Conflict_Audit_Tool   read-only redirect map view
 *   - LuwiPress_Emerald_WPML_Drift_Tool            outdated translation detection
 *   - LuwiPress_Emerald_Legacy_Canvas_Tool         find Hello Elementor leftovers
 *   - LuwiPress_Emerald_Kit_CSS_Health_Tool        Kit CSS size + headroom audit
 *   - LuwiPress_Emerald_Orphan_Media_Tool          unreferenced uploads (read-only)
 *
...
class LuwiPress_Emerald_Slug_Conflict_Audit_Tool {
	...
	public static function scan( $args = array(), $tool = array() ) {
		...
		$enabled = (bool) get_theme_mod( 'luwipress_emerald_resolve_slug_conflicts', false );
		return array(
...
class LuwiPress_Emerald_WPML_Drift_Tool {
...
class LuwiPress_Emerald_Legacy_Canvas_Tool {
...
class LuwiPress_Emerald_Kit_CSS_Health_Tool {
...
class LuwiPress_Emerald_Orphan_Media_Tool {
...
class LuwiPress_Emerald_WPML_Structure_Sync_Tool {
...
class LuwiPress_Emerald_Unwanted_Landing_Pages_Tool {
	...
	private static function commercial_keywords() {
		return apply_filters( 'luwipress_emerald_unwanted_landing_keywords', array(
			// EN
...
class LuwiPress_Emerald_Subcategory_Template_Parity_Tool {
...
class LuwiPress_Emerald_Triangle_Health_Tool {
	...
	public static function scan( $args = array(), $tool = array() ) {
		...
		if ( ( $wpml || $polylang ) && class_exists( 'LuwiPress_Emerald_WPML_Structure_Sync_Tool' ) ) {
			$wpml_audit = LuwiPress_Emerald_WPML_Structure_Sync_Tool::scan( array(), array() );
		...
		if ( $wc && ( $wpml || $polylang ) && class_exists( 'LuwiPress_Emerald_Subcategory_Template_Parity_Tool' ) ) {
			$subcat = LuwiPress_Emerald_Subcategory_Template_Parity_Tool::scan( array(), array() );
		...
		if ( class_exists( 'LuwiPress_Emerald_Unwanted_Landing_Pages_Tool' ) ) {
			$orphan = LuwiPress_Emerald_Unwanted_Landing_Pages_Tool::scan( array(), array() );
