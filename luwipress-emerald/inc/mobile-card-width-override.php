 ...
 *   `<style id="lwp-emerald-mobile-90">` block AFTER the kit. Same selector,
 ...
 * with sister plugins.
 *
 * Operator toggle: filter `luwipress_emerald_mobile_90_enabled` returning
...
if ( ! function_exists( 'luwipress_emerald_emit_mobile_card_width_override' ) ) {
	 ...
	 */
	function luwipress_emerald_emit_mobile_card_width_override() {
		if ( is_admin() ) {
			return;
		}
		/**
		 ...
		 */
		if ( ! (bool) apply_filters( 'luwipress_emerald_mobile_90_enabled', true ) ) {
			return;
		}
		echo "\n<style id=\"lwp-emerald-mobile-90\">\n";
	...
	add_action( 'wp_head', 'luwipress_emerald_emit_mobile_card_width_override', 999 );
}
