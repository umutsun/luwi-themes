...
add_action( 'after_setup_theme', function () {
	load_theme_textdomain( 'luwipress-emerald', LUWIPRESS_EMERALD_DIR . '/languages' );
	...
	register_nav_menus( [
		'primary' => __( 'Primary navigation (header fallback)', 'luwipress-emerald' ),
		'mobile'  => __( 'Mobile drawer (header fallback)', 'luwipress-emerald' ),
		'footer'  => __( 'Footer fallback', 'luwipress-emerald' ),
	] );

	// Image sizes used inside Elementor Kit JSONs.
	add_image_size( 'luwipress-emerald-card', 600, 600, true );
	add_image_size( 'luwipress-emerald-cat',  600, 660, true );
	add_image_size( 'luwipress-emerald-hero', 1100, 1100, false );
	add_image_size( 'luwipress-emerald-editorial',      900, 720, true );
	add_image_size( 'luwipress-emerald-editorial-feat', 1100, 880, true );
}, 5 );
