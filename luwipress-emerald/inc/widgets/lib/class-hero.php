...
class LuwiPress_Emerald_Widget_Hero extends Widget_Base {

	public function get_name()        { return 'lwp-hero'; }
	public function get_title()       { return __( 'Hero', 'luwipress-emerald' ); }
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'split',
				'options' => [
					'split'      => __( 'Split (text + visual side-by-side)', 'luwipress-emerald' ),
					'centered'   => __( 'Centered (headline above image)', 'luwipress-emerald' ),
					'full-bleed' => __( 'Full-bleed (image cover + text overlay)', 'luwipress-emerald' ),
				],
			]
		);
		...
		/* Content */
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Content', 'luwipress-emerald' ) ] );
		$this->add_control(
			'eyebrow',
			[
				'label'   => __( 'Eyebrow', 'luwipress-emerald' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Welcome · Worldwide shipping', 'luwipress-emerald' ),
			]
		);
		$this->add_control(
			'headline',
			[
				'label'       => __( 'Headline (HTML allowed)', 'luwipress-emerald' ),
				'type'        => Controls_Manager::TEXTAREA,
				'rows'        => 3,
				'default'     => __( 'Your headline<br>in <em>two lines</em> with a <span class="underline">highlighted phrase</span>.', 'luwipress-emerald' ),
				'description' => __( 'Use <em>…</em> for italic emphasis (gold) and <span class="underline">…</span> for the underline accent.', 'luwipress-emerald' ),
			]
		);
		$this->add_control(
			'lead',
			[
				...
				'type'    => Controls_Manager::TEXTAREA,
				'rows'    => 3,
				'default' => __( 'A short paragraph explaining who you are and what you make. Replace this copy from the widget editor.', 'luwipress-emerald' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Explore the collection', 'luwipress-emerald' ),
			]
		);
		$this->add_control(
			'cta_primary_url',
		...
		$this->add_control(
			'image',
			[
				'label'       => __( 'Visual', 'luwipress-emerald' ),
				'type'        => Controls_Manager::MEDIA,
				'default'     => [ 'url' => '' ],
				'description' => __( 'Used in split + centered + full-bleed variants. Falls back to a gradient.', 'luwipress-emerald' ),
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			'show_stats',
			[
				'label'   => __( 'Show stats row', 'luwipress-emerald' ),
		...
		$repeater->add_control(
			'value',
			[ 'label' => __( 'Value', 'luwipress-emerald' ), 'type' => Controls_Manager::TEXT, 'default' => '1,200+' ]
		);
		$repeater->add_control(
			'label',
			[ 'label' => __( 'Label', 'luwipress-emerald' ), 'type' => Controls_Manager::TEXT, 'default' => 'Instruments' ]
		);
		$this->add_control(
			'stats',
			[
				'label'       => __( 'Stat cards', 'luwipress-emerald' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $repeater->get_controls(),
				'title_field' => '{{{ value }}} — {{{ label }}}',
				'default'     => [
					[ 'value' => '1,200+', 'label' => __( 'Instruments', 'luwipress-emerald' ) ],
					[ 'value' => '28',     'label' => __( 'Master makers', 'luwipress-emerald' ) ],
					[ 'value' => '47',     'label' => __( 'Countries shipped', 'luwipress-emerald' ) ],
				],
		...
		$this->start_controls_section( 'section_master', [
			'label'     => __( 'Master overlay', 'luwipress-emerald' ),
			'condition' => [ 'variant' => [ 'split', 'full-bleed' ] ],
		] );
		$this->add_control(
			'master_avatar',
			[
				'label'       => __( 'Master avatar', 'luwipress-emerald' ),
				'type'        => Controls_Manager::MEDIA,
				'default'     => [ 'url' => '' ],
				'description' => __( 'Square portrait — anything from 96×96 up. Empty to disable the overlay.', 'luwipress-emerald' ),
			]
		);
		$this->add_control(
			'master_name',
			[
				'label'   => __( 'Master name', 'luwipress-emerald' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Yıldırım Palabıyık', 'luwipress-emerald' ),
			]
		);
		$this->add_control(
			'master_role',
			[
				'label'   => __( 'Master role', 'luwipress-emerald' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Role · Location', 'luwipress-emerald' ),
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			'overlay_color',
			[
				'label'     => __( 'Image overlay (full-bleed only)', 'luwipress-emerald' ),
