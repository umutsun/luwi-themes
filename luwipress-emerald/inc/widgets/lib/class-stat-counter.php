...
class LuwiPress_Emerald_Widget_Stat_Counter extends Widget_Base {

	public function get_name()        { return 'lwp-stat-counter'; }
	public function get_title()       { return __( 'Stat Counter', 'luwipress-emerald' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_items', [ 'label' => __( 'Stats', 'luwipress-emerald' ) ] );

		$rep = new Repeater();
		$rep->add_control( 'number', [ 'label' => __( 'Number', 'luwipress-emerald' ), 'type' => Controls_Manager::NUMBER, 'default' => 240 ] );
		$rep->add_control( 'prefix', [ 'label' => __( 'Prefix (e.g. €)', 'luwipress-emerald' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$rep->add_control( 'suffix', [ 'label' => __( 'Suffix (e.g. + or k)', 'luwipress-emerald' ), 'type' => Controls_Manager::TEXT, 'default' => '+' ] );
		$rep->add_control( 'label',  [ 'label' => __( 'Label', 'luwipress-emerald' ), 'type' => Controls_Manager::TEXT, 'default' => __( 'Products in catalogue', 'luwipress-emerald' ) ] );
		$rep->add_control( 'sub',    [ 'label' => __( 'Sub line (optional)', 'luwipress-emerald' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$rep->add_control( 'icon',   [ 'label' => __( 'Icon (optional)', 'luwipress-emerald' ), 'type' => Controls_Manager::ICONS, 'default' => [ 'value' => '', 'library' => '' ] ] );
		...
		$this->add_control( 'items', [
			...
			'default'     => [
				[ 'number' => 100, 'suffix' => '+',   'label' => __( 'Products', 'luwipress-emerald' ) ],
				[ 'number' => 10,  'suffix' => '',    'label' => __( 'Countries shipped', 'luwipress-emerald' ) ],
				[ 'number' => 5,   'suffix' => '',    'label' => __( 'Team members', 'luwipress-emerald' ) ],
				[ 'number' => 3,   'suffix' => ' yrs', 'label' => __( 'In business', 'luwipress-emerald' ) ],
			],
		] );
		...
		$this->add_control( 'duration', [
			'label'   => __( 'Count-up duration (ms)', 'luwipress-emerald' ),
		...
		$this->add_control( 'show_dividers', [
			'label'        => __( 'Vertical dividers', 'luwipress-emerald' ),
