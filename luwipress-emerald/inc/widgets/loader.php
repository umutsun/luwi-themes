 ...
 *
 * Registers a "LuwiPress Emerald" widget category and 7 custom widgets:
...
add_action( 'elementor/init', function () {
	...
	add_action( 'elementor/widgets/register', function ( $widgets_manager ) {
		$widgets = [
			'class-product-card.php'     => 'LuwiPress_Emerald_Widget_Product_Card',
			'class-master-profile.php'   => 'LuwiPress_Emerald_Widget_Master_Profile',
			'class-timeline.php'         => 'LuwiPress_Emerald_Widget_Timeline',
			'class-info-bar.php'         => 'LuwiPress_Emerald_Widget_Info_Bar',
			'class-editorial-grid.php'   => 'LuwiPress_Emerald_Widget_Editorial_Grid',
			'class-hero.php'             => 'LuwiPress_Emerald_Widget_Hero',
			'class-mega-menu.php'        => 'LuwiPress_Emerald_Widget_Mega_Menu',
			'class-megabar.php'          => 'LuwiPress_Emerald_Widget_Megabar',
			'class-youtube-channel.php'  => 'LuwiPress_Emerald_Widget_YouTube_Channel',
			'class-instagram-channel.php' => 'LuwiPress_Emerald_Widget_Instagram_Channel',
			'class-section-head.php'     => 'LuwiPress_Emerald_Widget_Section_Head',
			'class-category-grid.php'    => 'LuwiPress_Emerald_Widget_Category_Grid',
			'class-master-grid.php'      => 'LuwiPress_Emerald_Widget_Master_Grid',
			'class-story-split.php'      => 'LuwiPress_Emerald_Widget_Story_Split',
			'class-hero-split.php'       => 'LuwiPress_Emerald_Widget_Hero_Split',
			'class-testimonials.php'     => 'LuwiPress_Emerald_Widget_Testimonials',
			'class-faq.php'              => 'LuwiPress_Emerald_Widget_FAQ',
			'class-trust-badges.php'     => 'LuwiPress_Emerald_Widget_Trust_Badges',
			'class-newsletter.php'       => 'LuwiPress_Emerald_Widget_Newsletter',
			'class-countdown.php'        => 'LuwiPress_Emerald_Widget_Countdown',
			'class-cta-banner.php'       => 'LuwiPress_Emerald_Widget_CTA_Banner',
			'class-stat-counter.php'     => 'LuwiPress_Emerald_Widget_Stat_Counter',
			'class-process-steps.php'    => 'LuwiPress_Emerald_Widget_Process_Steps',
			'class-ai-search.php'        => 'LuwiPress_Emerald_Widget_AI_Search',
			'class-featured-product.php' => 'LuwiPress_Emerald_Widget_Featured_Product',
			'class-featured-strip.php'   => 'LuwiPress_Emerald_Widget_Featured_Strip',
			'class-kg-stats.php'         => 'LuwiPress_Emerald_Widget_KG_Stats',
			'class-kg-trending.php'      => 'LuwiPress_Emerald_Widget_KG_Trending',
		];

		foreach ( $widgets as $file => $class ) {
			$path = LUWIPRESS_EMERALD_DIR . '/inc/widgets/lib/' . $file;
	...
	add_action( 'elementor/frontend/after_register_styles', function () {
		wp_register_style(
			'luwipress-emerald-widgets',
			LUWIPRESS_EMERALD_URI . '/assets/css/widgets.css',
			[ 'luwipress-emerald-tokens' ],
