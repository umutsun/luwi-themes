 ...
 *
 * Required plugins for LuwiPress Emerald:
...
class LuwiPress_Emerald_TGM_Bridge {
	...
	public function manifest() {
		return [
			'elementor' => [
				...
				'wporg'    => 'elementor',
				'required' => true,
				'why'      => __( 'Page builder — required for the LuwiPress Emerald templates.', 'luwipress-emerald' ),
			],
			'elementskit-lite' => [
				...
				'required' => true,
				'why'      => __( 'Header builder + mega menu — bundled kit relies on this for the sticky header.', 'luwipress-emerald' ),
			],
			'woocommerce' => [
				'name'     => 'WooCommerce',
				'slug'     => 'woocommerce',
				...
				'why'      => __( 'E-commerce backbone — required for the shop, single product, cart, checkout, and account templates.', 'luwipress-emerald' ),
			],
		];
	}
