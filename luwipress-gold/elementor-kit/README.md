# LuwiPress Gold — Theme Kit · Installation Guide
...
`00-animations.json` is the LuwiPress Gold animation layer — a single HTML widget that owns the page loader, scroll reveal, skeleton placeholders and hover micro-interactions.
...
:root{
  ...
  --lwp-border:#E8DFC8; --lwp-gold:#9A7B3A; --lwp-gold-bright:#D4AF37;
...
├── 00-animations.json        ← LuwiPress Gold animation layer (loader + reveal + skeleton)
