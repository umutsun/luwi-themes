...
<footer class="lwp-site-footer" role="contentinfo">
	...
	<div class="lwp-site-footer-bottom">
		<span class="lwp-site-footer-bottom__copy">
			...
			&middot; <a class="lwp-site-footer-theme-credit" href="https://luwi.dev/luwipress" target="_blank" rel="noopener" style="color:var(--primary-light);text-decoration:none">LuwiPress Gold <?php esc_html_e( 'Theme', 'luwipress-gold' ); ?></a>
		</span>
		<?php
