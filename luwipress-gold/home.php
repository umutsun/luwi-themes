...
if ( ! $blog_title ) {
	$blog_title = __( 'Journal', 'luwipress-gold' );
}
$blog_subtitle = (string) get_theme_mod(
	'luwipress_gold_journal_subtitle',
	__( 'Field notes, workshop visits and long reads from the atelier.', 'luwipress-gold' )
);
?>
...
<main class="lwp-page lwp-journal" id="primary">
	<div class="lwp-page-container">
		...
		<header class="lwp-journal-header">
			<span class="lwp-eyebrow">— <?php esc_html_e( 'Long reads from the atelier', 'luwipress-gold' ); ?></span>
		...
		<?php else : ?>
			...
			<div class="lwp-jnl-empty">
				<p><?php esc_html_e( 'No posts yet — the atelier is still drafting.', 'luwipress-gold' ); ?></p>
			</div>
