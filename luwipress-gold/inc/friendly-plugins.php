...
add_action( 'after_setup_theme', function () {
	...
	add_filter( 'luwipress_gold_breadcrumb_html', function ( $default_html ) {
 ...
 */
add_filter( 'luwipress_gold_ecosystem_features', function ( $features ) {
 ...
 * @return string
 */
function lwp_gold_filter_breadcrumb( $default_html ) {
	return apply_filters( 'luwipress_gold_breadcrumb_html', $default_html );
}
