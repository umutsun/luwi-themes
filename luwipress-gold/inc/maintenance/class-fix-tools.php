 ...
 *
 *   - LuwiPress_Gold_WPML_Term_Repair_Tool          register missing translated terms
 *   - LuwiPress_Gold_Menu_Propagate_Tool            sync new menu items to sibling menus
 *   - LuwiPress_Gold_Product_Translation_Tool       find products missing in some languages
 *   - LuwiPress_Gold_Template_Assignment_Tool       audit + apply forced PDP/archive template ids
 *
...
class LuwiPress_Gold_WPML_Term_Repair_Tool {
...
class LuwiPress_Gold_Menu_Propagate_Tool {
...
class LuwiPress_Gold_Product_Translation_Tool {
...
class LuwiPress_Gold_Template_Assignment_Tool {

	public static function scan( $args = array(), $tool = array() ) {
		$forced_pdp     = (int) get_theme_mod( 'luwipress_gold_pdp_template_id', 0 );
		$forced_archive = (int) get_theme_mod( 'luwipress_gold_archive_template_id', 0 );
