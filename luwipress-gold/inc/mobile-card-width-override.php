 ...
 *   `<style id="lwp-gold-mobile-90">` block AFTER the kit. Same selector,
 ...
 * with sister plugins.
 *
 * Operator toggle: filter `luwipress_gold_mobile_90_enabled` returning
...
if ( ! function_exists( 'luwipress_gold_emit_mobile_card_width_override' ) ) {
	 ...
	 */
	function luwipress_gold_emit_mobile_card_width_override() {
		if ( is_admin() ) {
			return;
		}
		/**
		 ...
		 */
		if ( ! (bool) apply_filters( 'luwipress_gold_mobile_90_enabled', true ) ) {
			return;
		}
		echo "\n<style id=\"lwp-gold-mobile-90\">\n";
