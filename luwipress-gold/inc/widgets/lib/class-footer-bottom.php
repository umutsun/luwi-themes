...
class LuwiPress_Gold_Widget_Footer_Bottom extends Widget_Base {

	public function get_name()        { return 'lwp-footer-bottom'; }
	public function get_title()       { return __( 'Footer Bottom', 'luwipress-gold' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_left', [ 'label' => __( 'Copyright + Legal', 'luwipress-gold' ) ] );

		$this->add_control(
			'copyright',
			[
				'label'   => __( 'Copyright line', 'luwipress-gold' ),
				'description' => __( 'Use %YEAR% to insert the current year automatically.', 'luwipress-gold' ),
		...
		$rep = new Repeater();
		$rep->add_control( 'label', [ 'label' => __( 'Label', 'luwipress-gold' ), 'type' => Controls_Manager::TEXT, 'default' => 'Privacy' ] );
		$rep->add_control( 'url',   [ 'label' => __( 'URL', 'luwipress-gold' ),   'type' => Controls_Manager::URL,  'default' => [ 'url' => '#' ] ] );

		$this->add_control(
			'legal_links',
			[
				'label'       => __( 'Legal links', 'luwipress-gold' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $rep->get_controls(),
				'title_field' => '{{{ label || "Link" }}}',
				'default'     => [
					[ 'label' => __( 'Privacy', 'luwipress-gold' ), 'url' => [ 'url' => '/privacy' ] ],
					[ 'label' => __( 'Terms', 'luwipress-gold' ),   'url' => [ 'url' => '/terms' ] ],
					[ 'label' => __( 'Cookies', 'luwipress-gold' ), 'url' => [ 'url' => '/cookies' ] ],
				],
			]
		);
		...
		/* Payment methods */
		$this->start_controls_section( 'section_pay', [ 'label' => __( 'Payment methods', 'luwipress-gold' ) ] );

		$this->add_control(
			'pay_label',
			[
				'label'   => __( 'Payment label', 'luwipress-gold' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Secure payments', 'luwipress-gold' ),
			]
		);

		$rep_pay = new Repeater();
		$rep_pay->add_control( 'label', [ 'label' => __( 'Method', 'luwipress-gold' ), 'type' => Controls_Manager::TEXT, 'default' => 'VISA' ] );

		$this->add_control(
			'pay_methods',
			[
				'label'       => __( 'Methods', 'luwipress-gold' ),
				'type'        => Controls_Manager::REPEATER,
		...
		$this->add_control(
			'pay_bg',
			[
				'label'   => __( 'Pay badge bg', 'luwipress-gold' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#1A1612',
		...
		$this->add_control(
			'pay_border',
			[
				'label'   => __( 'Pay badge border', 'luwipress-gold' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#3a342c',
