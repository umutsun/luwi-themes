...
class LuwiPress_Gold_Widget_Header_Actions extends Widget_Base {

	public function get_name()        { return 'lwp-header-actions'; }
	public function get_title()       { return __( 'Header Actions', 'luwipress-gold' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Actions', 'luwipress-gold' ) ] );

		$this->add_control( 'show_search',  [ 'label' => __( 'Show search', 'luwipress-gold' ), 'type' => Controls_Manager::SWITCHER, 'return_value' => 'yes', 'default' => 'yes' ] );

		$this->add_control( 'show_account', [ 'label' => __( 'Show account', 'luwipress-gold' ), 'type' => Controls_Manager::SWITCHER, 'return_value' => 'yes', 'default' => 'yes' ] );
		$this->add_control(
			'account_url',
			[
				'label'     => __( 'Account URL', 'luwipress-gold' ),
		...
		$this->add_control( 'show_cart',    [ 'label' => __( 'Show cart', 'luwipress-gold' ), 'type' => Controls_Manager::SWITCHER, 'return_value' => 'yes', 'default' => 'yes' ] );
		$this->add_control(
			'cart_url',
			[
				'label'     => __( 'Cart URL', 'luwipress-gold' ),
				'type'      => Controls_Manager::URL,
				'default'   => [ 'url' => '/cart' ],
		...
		$this->add_control(
			'cta_label',
			[
				'label'   => __( 'CTA label (optional)', 'luwipress-gold' ),
				'description' => __( 'Empty = no CTA button.', 'luwipress-gold' ),
		...
		$this->add_control( 'show_burger',  [ 'label' => __( 'Show mobile burger', 'luwipress-gold' ), 'type' => Controls_Manager::SWITCHER, 'return_value' => 'yes', 'default' => 'yes' ] );
		...
		$this->add_control(
			'icon_color',
			[ 'label' => __( 'Icon color', 'luwipress-gold' ), 'type' => Controls_Manager::COLOR, 'default' => '#1A1612',
				'selectors' => [ '{{WRAPPER}} .lwp-ha__icon' => 'color: {{VALUE}};' ] ]
		);
		$this->add_control(
			'icon_border',
			[ 'label' => __( 'Icon border', 'luwipress-gold' ), 'type' => Controls_Manager::COLOR, 'default' => '#E8DFC8',
				'selectors' => [ '{{WRAPPER}} .lwp-ha__icon' => 'border-color: {{VALUE}};' ] ]
		);
		$this->add_control(
			'accent_color',
			[ 'label' => __( 'Hover accent', 'luwipress-gold' ), 'type' => Controls_Manager::COLOR, 'default' => '#9A7B3A',
				'selectors' => [ '{{WRAPPER}} .lwp-ha__icon:hover' => 'color: {{VALUE}}; border-color: {{VALUE}};' ] ]
		);
		$this->add_control(
			'cta_bg',
			[ 'label' => __( 'CTA background', 'luwipress-gold' ), 'type' => Controls_Manager::COLOR, 'default' => '#1A1612',
				'selectors' => [ '{{WRAPPER}} .lwp-ha__cta' => 'background: {{VALUE}}; border-color: {{VALUE}};' ] ]
		);
		$this->add_control(
			'cta_text_color',
			[ 'label' => __( 'CTA text color', 'luwipress-gold' ), 'type' => Controls_Manager::COLOR, 'default' => '#ffffff',
				'selectors' => [ '{{WRAPPER}} .lwp-ha__cta' => 'color: {{VALUE}};' ] ]
		);
		$this->add_control(
			'badge_bg',
			[ 'label' => __( 'Cart badge bg', 'luwipress-gold' ), 'type' => Controls_Manager::COLOR, 'default' => '#D4AF37',
	...
	protected function render() {
		...
		<div class="lwp-ha">
			<?php if ( $show_search ) : ?>
				<button class="lwp-ha__icon" type="button" aria-label="<?php esc_attr_e( 'Search', 'luwipress-gold' ); ?>"
					data-lwp-trigger="search">
					<?php echo $this->svg_icon( 'search' ); ?>
				</button>
			<?php endif; ?>
			<?php if ( $show_account ) : ?>
				<a class="lwp-ha__icon" href="<?php echo esc_url( $account_url ); ?>" aria-label="<?php esc_attr_e( 'Account', 'luwipress-gold' ); ?>">
					<?php echo $this->svg_icon( 'user' ); ?>
				</a>
			<?php endif; ?>
			<?php if ( $show_cart && $this->wc_active() ) : ?>
				<a class="lwp-ha__icon lwp-ha__cart" href="<?php echo esc_url( $cart_url ); ?>" aria-label="<?php esc_attr_e( 'Cart', 'luwipress-gold' ); ?>">
			...
			<?php endif; ?>
			<?php if ( $show_burger ) : ?>
				<button class="lwp-ha__burger" type="button" aria-label="<?php esc_attr_e( 'Menu', 'luwipress-gold' ); ?>" data-lwp-trigger="mobile-nav">
