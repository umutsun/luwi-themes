...
class LuwiPress_Gold_Widget_Hero_Split extends Widget_Base {

	public function get_name()        { return 'lwp-hero-split'; }
	public function get_title()       { return __( 'Hero Split', 'luwipress-gold' ); }
	...
	protected function register_controls() {
		...
		/* Left: copy */
		$this->start_controls_section( 'section_copy', [ 'label' => __( 'Copy (left column)', 'luwipress-gold' ) ] );
		...
		/* Stats row */
		$this->start_controls_section( 'section_stats', [ 'label' => __( 'Stats row', 'luwipress-gold' ) ] );

		$rep = new Repeater();
		$rep->add_control( 'num',   [ 'label' => __( 'Number', 'luwipress-gold' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$rep->add_control( 'label', [ 'label' => __( 'Label', 'luwipress-gold' ),  'type' => Controls_Manager::TEXTAREA, 'rows' => 2, 'default' => '' ] );
		...
		/* Right: image side */
		$this->start_controls_section( 'section_image', [ 'label' => __( 'Image (right column)', 'luwipress-gold' ) ] );
		...
		$this->add_control( 'image_grad_from', [
			'label' => __( 'Gradient start (fallback)', 'luwipress-gold' ),
			'type'  => Controls_Manager::COLOR,
			'default' => '#3d2f1f',
		] );
		$this->add_control( 'image_grad_to', [
			'label' => __( 'Gradient end (fallback)', 'luwipress-gold' ),
			'type'  => Controls_Manager::COLOR,
			'default' => '#7a5a2c',
		] );
		...
		/* Master quote card */
		$this->start_controls_section( 'section_quote', [ 'label' => __( 'Master quote card', 'luwipress-gold' ) ] );

		$this->add_control( 'quote_avatar', [
			'label' => __( 'Avatar image (optional)', 'luwipress-gold' ),
			'type'  => Controls_Manager::MEDIA,
			'default' => [ 'url' => '' ],
		] );
		...
		$this->add_control( 'quote_role', [
			'label' => __( 'Role', 'luwipress-gold' ),
			'type'  => Controls_Manager::TEXT,
			'default' => '',
		] );
		$this->add_control( 'quote_text', [
			'label' => __( 'Quote', 'luwipress-gold' ),
			'type'  => Controls_Manager::TEXTAREA,
			'rows'  => 2,
			'default' => '',
		] );
