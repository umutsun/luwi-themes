...
class LuwiPress_Gold_Widget_Info_Bar extends Widget_Base {

	public function get_name()        { return 'lwp-info-bar'; }
	public function get_title()       { return __( 'Info Bar', 'luwipress-gold' ); }
	...
	protected function register_controls() {
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Items', 'luwipress-gold' ) ] );

		$repeater = new Repeater();
		$repeater->add_control(
			'icon',
			[
				'label'   => __( 'Icon', 'luwipress-gold' ),
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'Free shipping', 'luwipress-gold' ),
			]
		);
		$repeater->add_control(
			'desc',
			[
				'label'   => __( 'Description', 'luwipress-gold' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Worldwide · DHL Express', 'luwipress-gold' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'title_field' => '{{{ title }}}',
				'default'     => [
					[ 'title' => __( 'Free shipping', 'luwipress-gold' ),    'desc' => __( 'Worldwide · DHL Express', 'luwipress-gold' ),    'icon' => [ 'value' => 'fas fa-shipping-fast', 'library' => 'fa-solid' ] ],
					[ 'title' => __( '15-day warranty', 'luwipress-gold' ), 'desc' => __( 'Easy returns, no questions', 'luwipress-gold' ), 'icon' => [ 'value' => 'fas fa-undo-alt',     'library' => 'fa-solid' ] ],
					[ 'title' => __( 'Hand-tuned', 'luwipress-gold' ),       'desc' => __( 'Before every shipment', 'luwipress-gold' ),     'icon' => [ 'value' => 'fas fa-music',        'library' => 'fa-solid' ] ],
					[ 'title' => __( '100% secure', 'luwipress-gold' ),     'desc' => __( 'Trusted checkout', 'luwipress-gold' ),           'icon' => [ 'value' => 'fas fa-lock',         'library' => 'fa-solid' ] ],
				],
			]
		);
		...
		$this->add_control(
			'bar_bg',
			[
				'label'     => __( 'Bar background', 'luwipress-gold' ),
		...
		$this->add_control(
			'desc_color',
			[
				'label'     => __( 'Description color', 'luwipress-gold' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#9b9285',
