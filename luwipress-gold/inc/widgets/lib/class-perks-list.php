...
class LuwiPress_Gold_Widget_Perks_List extends Widget_Base {

	public function get_name()        { return 'lwp-perks-list'; }
	public function get_title()       { return __( 'Perks List', 'luwipress-gold' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Perks', 'luwipress-gold' ) ] );

		$rep = new Repeater();
		$rep->add_control(
			'icon_type',
			[
				'label'   => __( 'Icon style', 'luwipress-gold' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'check',
				'options' => [
					'check'    => __( 'Check', 'luwipress-gold' ),
					'truck'    => __( 'Truck', 'luwipress-gold' ),
					'shield'   => __( 'Shield', 'luwipress-gold' ),
					'tool'     => __( 'Tool', 'luwipress-gold' ),
					'star'     => __( 'Star', 'luwipress-gold' ),
					'heart'    => __( 'Heart', 'luwipress-gold' ),
					'leaf'     => __( 'Leaf', 'luwipress-gold' ),
					'gift'     => __( 'Gift', 'luwipress-gold' ),
					'phone'    => __( 'Phone', 'luwipress-gold' ),
				],
			]
		);
		$rep->add_control( 'strong', [ 'label' => __( 'Bold lead', 'luwipress-gold' ), 'type' => Controls_Manager::TEXT, 'default' => 'Hand-tuned' ] );
		$rep->add_control( 'body',   [ 'label' => __( 'Body', 'luwipress-gold' ),     'type' => Controls_Manager::TEXT, 'default' => 'in our atelier before shipping' ] );

		$this->add_control(
			'perks',
			[
				'label'       => __( 'Perks', 'luwipress-gold' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $rep->get_controls(),
				'title_field' => '{{{ strong || "Perk" }}}',
				'default'     => [
					[ 'icon_type' => 'check',  'strong' => __( 'Hand-tuned', 'luwipress-gold' ),     'body' => __( 'in our atelier before shipping', 'luwipress-gold' ) ],
					[ 'icon_type' => 'truck',  'strong' => __( 'Free DHL shipping', 'luwipress-gold' ), 'body' => __( 'on orders over €450', 'luwipress-gold' ) ],
					[ 'icon_type' => 'shield', 'strong' => __( '2-year warranty', 'luwipress-gold' ), 'body' => __( '+ lifetime tuning support', 'luwipress-gold' ) ],
				],
			]
		);
		...
		$this->add_control( 'icon_color',   [ 'label' => __( 'Icon color', 'luwipress-gold' ),   'type' => Controls_Manager::COLOR, 'default' => '#9A7B3A',
			'selectors' => [ '{{WRAPPER}} .lwp-perks__icon' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'strong_color', [ 'label' => __( 'Bold color', 'luwipress-gold' ),   'type' => Controls_Manager::COLOR, 'default' => '#1A1612',
			'selectors' => [ '{{WRAPPER}} .lwp-perks__strong' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'body_color',   [ 'label' => __( 'Body color', 'luwipress-gold' ),   'type' => Controls_Manager::COLOR, 'default' => '#3a342c',
