...
class LuwiPress_Gold_Widget_Spec_List extends Widget_Base {

	public function get_name()        { return 'lwp-spec-list'; }
	public function get_title()       { return __( 'Spec List', 'luwipress-gold' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Specs', 'luwipress-gold' ) ] );
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'attributes' => __( 'Auto: current product attributes (WC)', 'luwipress-gold' ),
				],
			]
		);

		$rep = new Repeater();
		$rep->add_control( 'label', [ 'label' => __( 'Label', 'luwipress-gold' ), 'type' => Controls_Manager::TEXT, 'default' => 'Material' ] );
		$rep->add_control( 'value', [ 'label' => __( 'Value', 'luwipress-gold' ), 'type' => Controls_Manager::TEXT, 'default' => 'Walnut' ] );

		$this->add_control(
			'rows',
			[
				'label'       => __( 'Rows', 'luwipress-gold' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $rep->get_controls(),
				'title_field' => '{{{ label || "Row" }}}',
				'default'     => [
					[ 'label' => __( 'Material', 'luwipress-gold' ), 'value' => 'Walnut' ],
					[ 'label' => __( 'Weight', 'luwipress-gold' ),   'value' => '1.4 kg' ],
				],
		...
		$this->add_control(
			...
			[
				...
				'type'    => Controls_Manager::SELECT,
				'default' => '1',
				'options' => [ '1' => __( 'Single column', 'luwipress-gold' ), '2' => __( 'Two columns', 'luwipress-gold' ) ],
			]
		);
		...
		$this->add_control( 'label_color', [ 'label' => __( 'Label color', 'luwipress-gold' ), 'type' => Controls_Manager::COLOR, 'default' => '#8b7f6a',
			'selectors' => [ '{{WRAPPER}} .lwp-spec dt' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'value_color', [ 'label' => __( 'Value color', 'luwipress-gold' ), 'type' => Controls_Manager::COLOR, 'default' => '#1A1612',
			'selectors' => [ '{{WRAPPER}} .lwp-spec dd' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'border_color', [ 'label' => __( 'Row border', 'luwipress-gold' ), 'type' => Controls_Manager::COLOR, 'default' => '#eae3d4',
