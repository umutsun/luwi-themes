...
class LuwiPress_Gold_Widget_Stat_Counter extends Widget_Base {

	public function get_name()        { return 'lwp-stat-counter'; }
	public function get_title()       { return __( 'Stat Counter', 'luwipress-gold' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_items', [ 'label' => __( 'Stats', 'luwipress-gold' ) ] );

		$rep = new Repeater();
		$rep->add_control( 'number', [ 'label' => __( 'Number', 'luwipress-gold' ), 'type' => Controls_Manager::NUMBER, 'default' => 240 ] );
		$rep->add_control( 'prefix', [ 'label' => __( 'Prefix (e.g. €)', 'luwipress-gold' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$rep->add_control( 'suffix', [ 'label' => __( 'Suffix (e.g. + or k)', 'luwipress-gold' ), 'type' => Controls_Manager::TEXT, 'default' => '+' ] );
		$rep->add_control( 'label',  [ 'label' => __( 'Label', 'luwipress-gold' ), 'type' => Controls_Manager::TEXT, 'default' => __( 'Products in catalogue', 'luwipress-gold' ) ] );
		$rep->add_control( 'sub',    [ 'label' => __( 'Sub line (optional)', 'luwipress-gold' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$rep->add_control( 'icon',   [ 'label' => __( 'Icon (optional)', 'luwipress-gold' ), 'type' => Controls_Manager::ICONS, 'default' => [ 'value' => '', 'library' => '' ] ] );
		...
		$this->add_control( 'duration', [
			'label'   => __( 'Count-up duration (ms)', 'luwipress-gold' ),
		...
		$this->add_control( 'show_dividers', [
			'label'        => __( 'Vertical dividers', 'luwipress-gold' ),
