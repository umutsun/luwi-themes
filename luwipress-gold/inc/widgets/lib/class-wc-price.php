...
class LuwiPress_Gold_Widget_WC_Price extends Widget_Base {

	public function get_name()        { return 'lwp-wc-price'; }
	public function get_title()       { return __( 'WC Product Price', 'luwipress-gold' ); }
	...
	protected function register_controls() {
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Price', 'luwipress-gold' ) ] );
		...
		$this->add_control( 'price_color', [
			'label' => __( 'Price color', 'luwipress-gold' ), 'type' => Controls_Manager::COLOR, 'default' => '#1A1612',
			'selectors' => [ '{{WRAPPER}} .lwp-wc-price' => 'color: {{VALUE}};' ],
		] );

		$this->add_control( 'sale_color', [
			'label' => __( 'Sale price color', 'luwipress-gold' ), 'type' => Controls_Manager::COLOR, 'default' => '#d83131',
			'selectors' => [ '{{WRAPPER}} .lwp-wc-price ins .amount, {{WRAPPER}} .lwp-wc-price ins' => 'color: {{VALUE}};' ],
		] );

		$this->add_control( 'strike_color', [
			'label' => __( 'Strikethrough color', 'luwipress-gold' ), 'type' => Controls_Manager::COLOR, 'default' => '#8b7f6a',
