...
Headline: **"LuwiPress Onyx — World Instruments WooCommerce Theme"**
...
Output: a single PHP class (e.g., `LuwiPress_Onyx_Customizer`)
...
`/releases/luwipress-onyx-1.2.3.zip` — design tokens are unchanged
