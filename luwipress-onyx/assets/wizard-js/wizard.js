/* LuwiPress Onyx — onboarding wizard front-end. */
(function ($) {
	'use strict';

	var ajaxurl  = LWP_ONYX_WIZARD.ajaxurl;
	var nonce    = LWP_ONYX_WIZARD.nonce;
	var i18n     = (LWP_ONYX_WIZARD_DATA && LWP_ONYX_WIZARD_DATA.i18n) || {};

	var $root  = $('.luwipress-onyx-wizard');
	...
	$root.on('change', '#lwp-ai-toggle', function () {
		...
		$.post(ajaxurl, {
			action: 'luwipress_onyx_wizard_step',
			step: 'ai_toggle',
			_ajax_nonce: nonce,
