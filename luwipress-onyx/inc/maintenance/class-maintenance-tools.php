 ...
 *
 *   - LuwiPress_Onyx_Slug_Conflict_Audit_Tool   read-only redirect map view
 *   - LuwiPress_Onyx_WPML_Drift_Tool            outdated translation detection
 *   - LuwiPress_Onyx_Legacy_Canvas_Tool         find Hello Elementor leftovers
 *   - LuwiPress_Onyx_Kit_CSS_Health_Tool        Kit CSS size + headroom audit
 *   - LuwiPress_Onyx_Orphan_Media_Tool          unreferenced uploads (read-only)
 *
...
class LuwiPress_Onyx_Slug_Conflict_Audit_Tool {
	...
	public static function scan( $args = array(), $tool = array() ) {
		...
		$enabled = (bool) get_theme_mod( 'luwipress_onyx_resolve_slug_conflicts', false );
		return array(
...
class LuwiPress_Onyx_WPML_Drift_Tool {
...
class LuwiPress_Onyx_Legacy_Canvas_Tool {
...
class LuwiPress_Onyx_Kit_CSS_Health_Tool {
...
class LuwiPress_Onyx_Orphan_Media_Tool {
...
class LuwiPress_Onyx_WPML_Structure_Sync_Tool {
...
class LuwiPress_Onyx_Unwanted_Landing_Pages_Tool {
	...
	private static function commercial_keywords() {
		return apply_filters( 'luwipress_onyx_unwanted_landing_keywords', array(
			// EN
...
class LuwiPress_Onyx_Subcategory_Template_Parity_Tool {
...
class LuwiPress_Onyx_Triangle_Health_Tool {
	...
	public static function scan( $args = array(), $tool = array() ) {
		...
		if ( ( $wpml || $polylang ) && class_exists( 'LuwiPress_Onyx_WPML_Structure_Sync_Tool' ) ) {
			$wpml_audit = LuwiPress_Onyx_WPML_Structure_Sync_Tool::scan( array(), array() );
		...
		if ( $wc && ( $wpml || $polylang ) && class_exists( 'LuwiPress_Onyx_Subcategory_Template_Parity_Tool' ) ) {
			$subcat = LuwiPress_Onyx_Subcategory_Template_Parity_Tool::scan( array(), array() );
		...
		if ( class_exists( 'LuwiPress_Onyx_Unwanted_Landing_Pages_Tool' ) ) {
			$orphan = LuwiPress_Onyx_Unwanted_Landing_Pages_Tool::scan( array(), array() );
