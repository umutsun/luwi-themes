...
if ( ! function_exists( 'luwipress_onyx_wc_page_fallback' ) ) {
	 ...
	 * @return string
	 */
	function luwipress_onyx_wc_page_fallback( $content ) {
	...
	add_filter( 'the_content', 'luwipress_onyx_wc_page_fallback', 999 );
}
