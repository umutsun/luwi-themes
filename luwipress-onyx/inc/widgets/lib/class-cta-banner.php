...
class LuwiPress_Onyx_Widget_CTA_Banner extends Widget_Base {

	public function get_name()        { return 'lwp-cta-banner'; }
	public function get_title()       { return __( 'CTA Banner', 'luwipress-onyx' ); }
	...
	protected function register_controls() {
		...
		$this->add_control( 'eyebrow', [ 'label' => __( 'Eyebrow', 'luwipress-onyx' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$this->add_control( 'heading', [
			'label'       => __( 'Headline', 'luwipress-onyx' ),
			'description' => __( 'Use Enter for line breaks. Wrap with [em]…[/em] for italic gold accent.', 'luwipress-onyx' ),
			'type'        => Controls_Manager::TEXTAREA,
			'rows'        => 3,
			'default'     => __( 'Build the instrument you have always wanted.', 'luwipress-onyx' ),
		] );
		$this->add_control( 'lead', [ 'label' => __( 'Lead', 'luwipress-onyx' ), 'type' => Controls_Manager::TEXTAREA, 'rows' => 3, 'default' => '' ] );

		$this->add_control( 'cta1_label', [ 'label' => __( 'Primary CTA — label', 'luwipress-onyx' ), 'type' => Controls_Manager::TEXT, 'default' => __( 'Start a custom order →', 'luwipress-onyx' ) ] );
		$this->add_control( 'cta1_url',   [ 'label' => __( 'Primary CTA — URL', 'luwipress-onyx' ),   'type' => Controls_Manager::URL,  'default' => [ 'url' => '' ] ] );
		$this->add_control( 'cta2_label', [ 'label' => __( 'Secondary CTA — label', 'luwipress-onyx' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$this->add_control( 'cta2_url',   [ 'label' => __( 'Secondary CTA — URL', 'luwipress-onyx' ),   'type' => Controls_Manager::URL,  'default' => [ 'url' => '' ] ] );

		$this->end_controls_section();

		$this->start_controls_section( 'section_bg', [ 'label' => __( 'Background', 'luwipress-onyx' ) ] );

		$this->add_control( 'bg_image', [
			'label' => __( 'Background image (optional)', 'luwipress-onyx' ),
			'type'  => Controls_Manager::MEDIA,
			'default' => [ 'url' => '' ],
		] );
		$this->add_control( 'bg_grad_from', [ 'label' => __( 'Gradient start', 'luwipress-onyx' ), 'type' => Controls_Manager::COLOR, 'default' => '#1A1612' ] );
		$this->add_control( 'bg_grad_to',   [ 'label' => __( 'Gradient end', 'luwipress-onyx' ),   'type' => Controls_Manager::COLOR, 'default' => '#3d2f1f' ] );

		$this->add_control( 'overlay', [
			'label' => __( 'Image overlay strength', 'luwipress-onyx' ),
			'description' => __( 'Only applies when a background image is set.', 'luwipress-onyx' ),
			'type'  => Controls_Manager::SELECT,
			'default' => 'medium',
			'options' => [
				'none'    => __( 'None', 'luwipress-onyx' ),
				'light'   => __( 'Light', 'luwipress-onyx' ),
				'medium'  => __( 'Medium', 'luwipress-onyx' ),
				'strong'  => __( 'Strong', 'luwipress-onyx' ),
			],
		] );

		$this->add_control( 'align', [
			'label' => __( 'Content alignment', 'luwipress-onyx' ),
			'type'  => Controls_Manager::SELECT,
			'default' => 'center',
			'options' => [
				'left'   => __( 'Left', 'luwipress-onyx' ),
				'center' => __( 'Center', 'luwipress-onyx' ),
				'right'  => __( 'Right', 'luwipress-onyx' ),
			],
		] );
