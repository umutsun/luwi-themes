...
class LuwiPress_Onyx_Widget_Footer_Brand extends Widget_Base {

	public function get_name()        { return 'lwp-footer-brand'; }
	public function get_title()       { return __( 'Footer Brand', 'luwipress-onyx' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_logo', [ 'label' => __( 'Logo', 'luwipress-onyx' ) ] );

		$this->add_control(
			'logo_image',
			[
				'label'   => __( 'Logo image (optional)', 'luwipress-onyx' ),
				'description' => __( 'If set, replaces the text logo.', 'luwipress-onyx' ),
		...
		$this->add_control(
			'logo_text',
			[
				'label'   => __( 'Logo text', 'luwipress-onyx' ),
		...
		$this->add_control(
			'accent_index',
			[
				'label'   => __( 'Accent character position (0-indexed)', 'luwipress-onyx' ),
				'description' => __( 'Which character to italicise + accent-tint. -1 = none.', 'luwipress-onyx' ),
		...
		$this->add_control(
			'logo_url',
			[
				'label'   => __( 'Logo link', 'luwipress-onyx' ),
		...
		/* Tagline */
		$this->start_controls_section( 'section_tag', [ 'label' => __( 'Tagline', 'luwipress-onyx' ) ] );
		$this->add_control(
			'tagline',
			[
				'label'   => __( 'Tagline / description', 'luwipress-onyx' ),
				'type'    => Controls_Manager::TEXTAREA,
				'rows'    => 3,
				'default' => __( 'A short brand line that explains what your store does and where you ship from.', 'luwipress-onyx' ),
			]
		);
		$this->end_controls_section();

		/* Contact */
		$this->start_controls_section( 'section_contact', [ 'label' => __( 'Contact', 'luwipress-onyx' ) ] );
		$this->add_control( 'phone',   [ 'label' => __( 'Phone', 'luwipress-onyx' ),   'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$this->add_control( 'email',   [ 'label' => __( 'Email', 'luwipress-onyx' ),   'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$this->add_control( 'address', [ 'label' => __( 'Address line', 'luwipress-onyx' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$this->end_controls_section();

		/* Social */
		$this->start_controls_section( 'section_social', [ 'label' => __( 'Social icons', 'luwipress-onyx' ) ] );

		$rep = new Repeater();
		$rep->add_control(
			'network',
			[
				'label'   => __( 'Network', 'luwipress-onyx' ),
		...
		$rep->add_control(
			'url',
			[ 'label' => __( 'URL', 'luwipress-onyx' ), 'type' => Controls_Manager::URL, 'default' => [ 'url' => '#' ] ]
		);

		$this->add_control(
			'socials',
			[
				'label'       => __( 'Social links', 'luwipress-onyx' ),
		...
		$this->add_control(
			'logo_color',
			[
				'label'   => __( 'Logo color', 'luwipress-onyx' ),
		...
		$this->add_control(
			'accent_color',
			[
				'label'   => __( 'Accent color', 'luwipress-onyx' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#D4AF37',
