...
class LuwiPress_Onyx_Widget_Footer_Column extends Widget_Base {

	public function get_name()        { return 'lwp-footer-column'; }
	public function get_title()       { return __( 'Footer Column', 'luwipress-onyx' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Column', 'luwipress-onyx' ) ] );
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Shop', 'luwipress-onyx' ),
			]
		);

		$rep = new Repeater();
		$rep->add_control( 'label', [ 'label' => __( 'Label', 'luwipress-onyx' ), 'type' => Controls_Manager::TEXT, 'default' => 'Link' ] );
		$rep->add_control( 'url',   [ 'label' => __( 'URL', 'luwipress-onyx' ),   'type' => Controls_Manager::URL,  'default' => [ 'url' => '#' ] ] );
		$rep->add_control(
			'hot',
			[
				'label'        => __( 'Highlight (sale / promo)', 'luwipress-onyx' ),
		...
		$this->add_control(
			'links',
			[
				'label'       => __( 'Links', 'luwipress-onyx' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $rep->get_controls(),
				'title_field' => '{{{ label || "Link" }}}',
				'default'     => [
					[ 'label' => __( 'Link 1', 'luwipress-onyx' ), 'url' => [ 'url' => '#' ] ],
					[ 'label' => __( 'Link 2', 'luwipress-onyx' ), 'url' => [ 'url' => '#' ] ],
					[ 'label' => __( 'Link 3', 'luwipress-onyx' ), 'url' => [ 'url' => '#' ] ],
				],
			]
		);
		...
		$this->add_control(
			'hot_color',
			[
				'label'     => __( 'Hot link color', 'luwipress-onyx' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#D4AF37',
