...
class LuwiPress_Onyx_Widget_Logo extends Widget_Base {

	public function get_name()        { return 'lwp-logo'; }
	public function get_title()       { return __( 'Logo', 'luwipress-onyx' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Logo', 'luwipress-onyx' ) ] );

		$this->add_control(
			'image',
			[
				'label'   => __( 'Image (optional)', 'luwipress-onyx' ),
				'description' => __( 'When set, replaces the text wordmark.', 'luwipress-onyx' ),
		...
		$this->add_control(
			'image_max_height',
			[
				'label'   => __( 'Image max height', 'luwipress-onyx' ),
		...
		$this->add_control(
			'text',
			[
				'label'   => __( 'Text wordmark', 'luwipress-onyx' ),
		...
		$this->add_control(
			'accent_index',
			[
				'label'   => __( 'Accent character index (0-based, -1 = none)', 'luwipress-onyx' ),
		...
		$this->add_control(
			'link_url',
			[
				'label'   => __( 'Link URL', 'luwipress-onyx' ),
		...
		$this->add_control(
			'accent_hover_color',
			[
				'label'   => __( 'Accent hover color', 'luwipress-onyx' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#D4AF37',
