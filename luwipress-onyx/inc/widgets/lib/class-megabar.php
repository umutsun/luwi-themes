...
class LuwiPress_Onyx_Widget_Megabar extends Widget_Base {

	public function get_name()        { return 'lwp-megabar'; }
	public function get_title()       { return __( 'Megabar (sub-cat strip)', 'luwipress-onyx' ); }
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'auto',
				'options' => [
					'auto'   => __( 'Auto (top sub-categories by product count)', 'luwipress-onyx' ),
					'manual' => __( 'Manual (specific slugs)', 'luwipress-onyx' ),
				],
			]
		);
		...
		$this->add_control(
			'manual_slugs',
			[
				'label'       => __( 'Slugs', 'luwipress-onyx' ),
				'type'        => Controls_Manager::TEXTAREA,
				'rows'        => 6,
				'description' => __( 'One slug per line. Order is preserved.', 'luwipress-onyx' ),
		...
		$this->add_control(
			'separator',
			[
				'label'   => __( 'Separator', 'luwipress-onyx' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'middot',
				'options' => [
					'middot' => '·',
		...
		$this->add_control(
			'link_color',
			[
				'label'     => __( 'Link color', 'luwipress-onyx' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#4d4635',
		...
		$this->add_control(
			'hover_color',
			[
				'label'     => __( 'Hover color', 'luwipress-onyx' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#735c00',
	...
	protected function render() {
		...
		if ( empty( $terms ) ) {
			echo '<div class="lwp-megabar lwp-megabar--empty">' . esc_html__( 'No sub-categories yet.', 'luwipress-onyx' ) . '</div>';
			return;
		}
