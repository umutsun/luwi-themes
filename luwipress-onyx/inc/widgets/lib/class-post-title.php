...
class LuwiPress_Onyx_Widget_Post_Title extends Widget_Base {

	public function get_name()        { return 'lwp-post-title'; }
	public function get_title()       { return __( 'Post Title', 'luwipress-onyx' ); }
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'justify' => [ 'title' => __( 'Justify', 'luwipress-onyx' ),'icon' => 'eicon-text-align-justify' ],
				],
		...
		$this->add_responsive_control(
			'margin',
			[
				'label'      => __( 'Margin', 'luwipress-onyx' ),
	...
	protected function render() {
		...
		if ( ! $post ) {
			...
			echo '<' . esc_attr( $tag ) . ' class="lwp-post-title">' . esc_html__( 'Post Title', 'luwipress-onyx' ) . '</' . esc_attr( $tag ) . '>';
			return;
		}
