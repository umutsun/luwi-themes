...
class LuwiPress_Onyx_Widget_Process_Steps extends Widget_Base {

	public function get_name()        { return 'lwp-process-steps'; }
	public function get_title()       { return __( 'Process Steps', 'luwipress-onyx' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_items', [ 'label' => __( 'Steps', 'luwipress-onyx' ) ] );

		$rep = new Repeater();
		$rep->add_control( 'title', [ 'label' => __( 'Title', 'luwipress-onyx' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$rep->add_control( 'body',  [ 'label' => __( 'Body', 'luwipress-onyx' ),  'type' => Controls_Manager::TEXTAREA, 'rows' => 3, 'default' => '' ] );
		$rep->add_control( 'icon',  [ 'label' => __( 'Icon (optional, overrides number)', 'luwipress-onyx' ), 'type' => Controls_Manager::ICONS, 'default' => [ 'value' => '', 'library' => '' ] ] );

		$this->add_control( 'items', [
			'label'       => __( 'Steps', 'luwipress-onyx' ),
			'type'        => Controls_Manager::REPEATER,
			'fields'      => $rep->get_controls(),
			'title_field' => '{{{ title || "Step" }}}',
			'default'     => [
				[ 'title' => __( 'Step 1',  'luwipress-onyx' ), 'body' => __( 'Describe the first step of your customer journey here.', 'luwipress-onyx' ) ],
				[ 'title' => __( 'Step 2',  'luwipress-onyx' ), 'body' => __( 'Second step — what happens after the customer takes step 1.', 'luwipress-onyx' ) ],
				[ 'title' => __( 'Step 3',  'luwipress-onyx' ), 'body' => __( 'Third step — the build / fulfillment / processing phase.', 'luwipress-onyx' ) ],
				[ 'title' => __( 'Step 4',  'luwipress-onyx' ), 'body' => __( 'Final step — delivery / handoff / after-sale.', 'luwipress-onyx' ) ],
			],
		] );

		$this->add_control( 'show_arrows', [
			'label'        => __( 'Show connecting arrows', 'luwipress-onyx' ),
			'type'         => Controls_Manager::SWITCHER,
			'return_value' => 'yes',
			'default'      => 'yes',
		] );
		$this->add_control( 'orientation', [
			'label'   => __( 'Orientation', 'luwipress-onyx' ),
			'type'    => Controls_Manager::SELECT,
			'default' => 'horizontal',
			'options' => [
				'horizontal' => __( 'Horizontal (cards in a row)', 'luwipress-onyx' ),
				'vertical'   => __( 'Vertical (left-aligned list)', 'luwipress-onyx' ),
			],
		] );
