...
class LuwiPress_Onyx_Widget_Reading_Progress extends Widget_Base {

	public function get_name()        { return 'lwp-reading-progress'; }
	public function get_title()       { return __( 'Reading Progress', 'luwipress-onyx' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Behavior', 'luwipress-onyx' ) ] );

		$this->add_control(
			'target_selector',
			[
				'label'   => __( 'Track selector (optional)', 'luwipress-onyx' ),
				'description' => __( 'CSS selector of the content area to track. Empty = whole page.', 'luwipress-onyx' ),
		...
		$this->add_control(
			'position',
			[
				'label'   => __( 'Position', 'luwipress-onyx' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'top',
				'options' => [
					'top'    => __( 'Sticky top', 'luwipress-onyx' ),
					'bottom' => __( 'Sticky bottom', 'luwipress-onyx' ),
					'inline' => __( 'Inline (no stick)', 'luwipress-onyx' ),
				],
			]
		);
		$this->add_control(
			'height',
			[
				'label'   => __( 'Bar height (px)', 'luwipress-onyx' ),
		...
		$this->add_control( 'track_color', [ 'label' => __( 'Track color', 'luwipress-onyx' ), 'type' => Controls_Manager::COLOR, 'default' => '#eae3d4',
			'selectors' => [ '{{WRAPPER}} .lwp-rp' => 'background: {{VALUE}};' ] ] );
		$this->add_control( 'bar_color', [ 'label' => __( 'Bar color', 'luwipress-onyx' ), 'type' => Controls_Manager::COLOR, 'default' => '#9A7B3A',
