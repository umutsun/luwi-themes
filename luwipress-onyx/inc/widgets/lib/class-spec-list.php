...
class LuwiPress_Onyx_Widget_Spec_List extends Widget_Base {

	public function get_name()        { return 'lwp-spec-list'; }
	public function get_title()       { return __( 'Spec List', 'luwipress-onyx' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Specs', 'luwipress-onyx' ) ] );
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'attributes' => __( 'Auto: current product attributes (WC)', 'luwipress-onyx' ),
				],
			]
		);

		$rep = new Repeater();
		$rep->add_control( 'label', [ 'label' => __( 'Label', 'luwipress-onyx' ), 'type' => Controls_Manager::TEXT, 'default' => 'Material' ] );
		$rep->add_control( 'value', [ 'label' => __( 'Value', 'luwipress-onyx' ), 'type' => Controls_Manager::TEXT, 'default' => 'Walnut' ] );

		$this->add_control(
			'rows',
			[
				'label'       => __( 'Rows', 'luwipress-onyx' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $rep->get_controls(),
				'title_field' => '{{{ label || "Row" }}}',
				'default'     => [
					[ 'label' => __( 'Material', 'luwipress-onyx' ), 'value' => 'Walnut' ],
					[ 'label' => __( 'Weight', 'luwipress-onyx' ),   'value' => '1.4 kg' ],
				],
		...
		$this->add_control(
			...
			[
				...
				'type'    => Controls_Manager::SELECT,
				'default' => '1',
				'options' => [ '1' => __( 'Single column', 'luwipress-onyx' ), '2' => __( 'Two columns', 'luwipress-onyx' ) ],
			]
		);
		...
		$this->add_control( 'label_color', [ 'label' => __( 'Label color', 'luwipress-onyx' ), 'type' => Controls_Manager::COLOR, 'default' => '#8b7f6a',
			'selectors' => [ '{{WRAPPER}} .lwp-spec dt' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'value_color', [ 'label' => __( 'Value color', 'luwipress-onyx' ), 'type' => Controls_Manager::COLOR, 'default' => '#1A1612',
			'selectors' => [ '{{WRAPPER}} .lwp-spec dd' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'border_color', [ 'label' => __( 'Row border', 'luwipress-onyx' ), 'type' => Controls_Manager::COLOR, 'default' => '#eae3d4',
