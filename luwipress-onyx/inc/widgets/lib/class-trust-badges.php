...
class LuwiPress_Onyx_Widget_Trust_Badges extends Widget_Base {

	public function get_name()        { return 'lwp-trust-badges'; }
	public function get_title()       { return __( 'Trust Badges', 'luwipress-onyx' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_items', [ 'label' => __( 'Badges', 'luwipress-onyx' ) ] );

		$rep = new Repeater();
		$rep->add_control( 'image', [ 'label' => __( 'Image (preferred)', 'luwipress-onyx' ), 'type' => Controls_Manager::MEDIA, 'default' => [ 'url' => '' ] ] );
		$rep->add_control( 'icon',  [ 'label' => __( 'Icon (fallback)', 'luwipress-onyx' ),  'type' => Controls_Manager::ICONS, 'default' => [ 'value' => '', 'library' => '' ] ] );
		$rep->add_control( 'label', [ 'label' => __( 'Label (optional)', 'luwipress-onyx' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$rep->add_control( 'url',   [ 'label' => __( 'Link (optional)', 'luwipress-onyx' ),  'type' => Controls_Manager::URL,  'default' => [ 'url' => '' ] ] );

		$this->add_control( 'items', [
			'label'       => __( 'Badges', 'luwipress-onyx' ),
		...
		$this->add_control( 'show_labels', [
			'label'        => __( 'Show labels under icons', 'luwipress-onyx' ),
		...
		$this->add_control( 'icon_color', [
			'label' => __( 'Icon color', 'luwipress-onyx' ),
			'type'  => Controls_Manager::COLOR,
			'default' => '',
			'selectors' => [ '{{WRAPPER}} .lwp-tb__item' => 'color: {{VALUE}};' ],
		] );
		$this->add_control( 'icon_size', [
			'label' => __( 'Icon size (px)', 'luwipress-onyx' ),
