...
class LuwiPress_Onyx_Widget_WC_Related extends Widget_Base {

	public function get_name()        { return 'lwp-wc-related'; }
	public function get_title()       { return __( 'WC Related Products', 'luwipress-onyx' ); }
	...
	protected function register_controls() {
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Related', 'luwipress-onyx' ) ] );

		$this->add_control( 'heading', [
			'label' => __( 'Heading', 'luwipress-onyx' ),
			'type'  => Controls_Manager::TEXT, 'default' => __( 'You may also enjoy', 'luwipress-onyx' ),
		] );
		...
		$this->add_control( 'order_by', [
			...
			'options' => [
				...
				'date'       => __( 'Date', 'luwipress-onyx' ),
				'price'      => __( 'Price', 'luwipress-onyx' ),
				'popularity' => __( 'Popularity', 'luwipress-onyx' ),
				'rating'     => __( 'Rating', 'luwipress-onyx' ),
			],
		] );
		...
		$this->add_control( 'heading_color', [
			'label' => __( 'Heading color', 'luwipress-onyx' ), 'type' => Controls_Manager::COLOR, 'default' => '#1A1612',
	...
	protected function render() {
		...
		if ( ! $product ) {
			echo '<div class="lwp-wc-related"><h2 class="lwp-wc-related__heading">' . esc_html( $s['heading'] ?? 'You may also enjoy' ) . '</h2><div class="lwp-wc-related__ph">' . esc_html__( '[Related products will render here on a product page.]', 'luwipress-onyx' ) . '</div></div>';
			return;
		}
