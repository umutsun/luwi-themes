 ...
 *
 * Required plugins for LuwiPress Onyx:
...
class LuwiPress_Onyx_TGM_Bridge {
	...
	public function manifest() {
		return [
			'elementor' => [
				...
				'wporg'    => 'elementor',
				'required' => true,
				'why'      => __( 'Page builder — required for the LuwiPress Onyx templates.', 'luwipress-onyx' ),
			],
			'elementskit-lite' => [
				...
				'required' => true,
				'why'      => __( 'Header builder + mega menu — bundled kit relies on this for the sticky header.', 'luwipress-onyx' ),
			],
			'woocommerce' => [
				'name'     => 'WooCommerce',
				'slug'     => 'woocommerce',
				...
				'why'      => __( 'E-commerce backbone — required for the shop, single product, cart, checkout, and account templates.', 'luwipress-onyx' ),
			],
		];
	}
