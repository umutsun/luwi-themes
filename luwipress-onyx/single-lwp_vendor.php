...
while ( have_posts() ) : the_post();
	...
	$socials = array(
		'website'    => array( 'icon' => 'eicon-globe',           'label' => __( 'Website', 'luwipress-onyx' ),    'url' => get_post_meta( $post_id, '_lwp_vendor_website',    true ) ),
					...
					<div class="lwp-person__meta-strip">
						<?php if ( $years > 0 ) : ?>
							<div class="lwp-person__stat">
								...
								<span class="lwp-person__stat-label"><?php esc_html_e( 'years active', 'luwipress-onyx' ); ?></span>
							</div>
						<?php endif; ?>
						<?php if ( $specialty ) : ?>
							<div class="lwp-person__stat">
								<span class="lwp-person__stat-num"><?php echo esc_html( $specialty ); ?></span>
								<span class="lwp-person__stat-label"><?php esc_html_e( 'specialty', 'luwipress-onyx' ); ?></span>
							</div>
						<?php endif; ?>
						<?php if ( $work_query && $work_query->found_posts > 0 ) : ?>
							<div class="lwp-person__stat">
								<span class="lwp-person__stat-num"><?php echo esc_html( $work_query->found_posts ); ?></span>
								<span class="lwp-person__stat-label"><?php esc_html_e( 'works', 'luwipress-onyx' ); ?></span>
							</div>
						<?php endif; ?>
					</div>
				...
				<section class="lwp-person__work">
					<h2 class="lwp-person__work-heading">
						...
						echo esc_html( sprintf(
							...
							__( 'Made by this %s', 'luwipress-onyx' ),
