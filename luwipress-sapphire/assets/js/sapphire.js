...
(function () {
  ...
  function applyTheme(t) {
    ...
    try { localStorage.setItem('sapphire_theme', t); } catch (e) {}
  }
  ...
  /* ===========================================================
     ...
     =========================================================== */
  (function () {
    var root = $('[data-sapphire-listings]');
    var dataEl = $('#sapphire-listings-data');
    ...
    function gridCard(p) {
      ...
      return '<article class="pcard" style="background:var(--sapphire-900)">' +
  ...
  /* ===========================================================
     ...
     =========================================================== */
  (function () {
    var root = $('[data-sapphire-gallery]');
    if (!root) return;
  ...
  /* ===========================================================
     ...
     =========================================================== */
  (function () {
    var gal = $('[data-sapphire-gallery-lb]');
    var lb = $('.lightbox');
    if (gal && lb) {
