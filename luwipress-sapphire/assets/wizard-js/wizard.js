/* LuwiPress Sapphire — onboarding wizard front-end. */
(function ($) {
	'use strict';

	var ajaxurl  = LWP_SAPPHIRE_WIZARD.ajaxurl;
	var nonce    = LWP_SAPPHIRE_WIZARD.nonce;
	var i18n     = (LWP_SAPPHIRE_WIZARD_DATA && LWP_SAPPHIRE_WIZARD_DATA.i18n) || {};

	var $root  = $('.luwipress-sapphire-wizard');
	...
	$root.on('change', '#lwp-ai-toggle', function () {
		...
		$.post(ajaxurl, {
			action: 'luwipress_sapphire_wizard_step',
			step: 'ai_toggle',
			_ajax_nonce: nonce,
