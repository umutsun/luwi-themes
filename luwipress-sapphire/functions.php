<?php
/**
 * LuwiPress Sapphire — Elementor-ready theme bootstrap.
 *
 ...
 */
$lwp_sapphire_theme_obj = function_exists( 'wp_get_theme' ) ? wp_get_theme() : null;
define(
	'LUWIPRESS_SAPPHIRE_VERSION',
	( $lwp_sapphire_theme_obj && $lwp_sapphire_theme_obj->get( 'Version' ) )
		? (string) $lwp_sapphire_theme_obj->get( 'Version' )
		: '1.0.0'
);
unset( $lwp_sapphire_theme_obj );
define( 'LUWIPRESS_SAPPHIRE_DIR', get_template_directory() );
define( 'LUWIPRESS_SAPPHIRE_URI', get_template_directory_uri() );

require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/setup.php';
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/template-helpers.php';
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/contact-form.php';
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/enqueue.php';
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/elementor-compat.php';
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/elementor-kit-sync.php';
...
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/maintenance/class-elementor-shell-tool.php';
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/maintenance/class-maintenance-tools.php';
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/maintenance/class-fix-tools.php';
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/maintenance/class-extra-audit-tools.php';
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/maintenance/class-seo-audit-tools.php';
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/maintenance/class-language-drift-tool.php';
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/maintenance/elementor-template-force.php';
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/maintenance/seo-enforcement.php';
...
add_filter( 'wp_prepare_themes_for_js', function ( $themes ) {
	...
	if ( isset( $themes[ $slug ]['screenshot'][0] ) ) {
		...
		$themes[ $slug ]['screenshot'][0] = add_query_arg( 'ver', LUWIPRESS_SAPPHIRE_VERSION, $url );
	}
	return $themes;
} );
...
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/luwipress-bridge.php';
...
// widgets (and any custom code reading lwp_sapphire_get_featured_ids()).
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/featured-products.php';
...
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/mega-menu-admin.php';
...
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/friendly-plugins.php';
...
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/ai-surface.php';

if ( class_exists( 'WooCommerce' ) ) {
	require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/wc-pdp-hooks.php';
	...
	require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/wc-pdp-gallery-override.php';
	...
	require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/archive-parent-enrichment.php';
	...
	require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/smart-filters.php';
	...
	require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/wc-page-fallback.php';
}
...
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/blog-page-fallback.php';
...
// (LuwiPress Sapphire → Performance → "Resolve page/category slug conflicts");
...
// hardcoded slugs.
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/template-redirects.php';
...
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/layout-fixes.php';
...
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/footer-enhancements.php';

// Mega menu Customizer panel — global defaults for menu choice,
// threshold, columns, counts, mobile mode, blog auto-inject.
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/mega-menu-customizer.php';

// (The Gold-inherited server-side page loader is intentionally NOT loaded
// for Sapphire — the design has no loader overlay; sapphire.js handles scroll reveal.)
...
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/loadmore.php';
...
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/engine-cpt-templates.php';

// Onboarding wizard — admin-only.
if ( is_admin() ) {
	require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/wizard/bootstrap.php';
	require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/ecosystem-dashboard.php';
	require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/migration.php';
}

// Custom Elementor widgets — registered on `elementor/init`.
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/widgets/loader.php';

// Customizer panel — Brand / Topbar / Header / Footer / Animation / Performance.
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/customizer/bootstrap.php';
...
require_once LUWIPRESS_SAPPHIRE_DIR . '/inc/mobile-card-width-override.php';
