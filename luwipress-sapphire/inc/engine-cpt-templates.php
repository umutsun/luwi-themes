 ...
 * @return bool
 */
function lwp_sapphire_is_engine_cpt( $post_type ) {
...
add_filter( 'single_template', function ( $template ) {
	...
	if ( lwp_sapphire_is_engine_cpt( $pt ) ) {
...
add_filter( 'archive_template', function ( $template ) {
	...
	if ( $pt && lwp_sapphire_is_engine_cpt( $pt ) ) {
 ...
 */
function lwp_sapphire_cpt_social_icon( $label ) {
