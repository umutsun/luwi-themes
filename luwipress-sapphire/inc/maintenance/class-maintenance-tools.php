 ...
 *
 *   - LuwiPress_Sapphire_Slug_Conflict_Audit_Tool   read-only redirect map view
 *   - LuwiPress_Sapphire_WPML_Drift_Tool            outdated translation detection
 *   - LuwiPress_Sapphire_Legacy_Canvas_Tool         find Hello Elementor leftovers
 *   - LuwiPress_Sapphire_Kit_CSS_Health_Tool        Kit CSS size + headroom audit
 *   - LuwiPress_Sapphire_Orphan_Media_Tool          unreferenced uploads (read-only)
 *
...
class LuwiPress_Sapphire_Slug_Conflict_Audit_Tool {
	...
	public static function scan( $args = array(), $tool = array() ) {
		...
		$enabled = (bool) get_theme_mod( 'luwipress_sapphire_resolve_slug_conflicts', false );
		return array(
...
class LuwiPress_Sapphire_WPML_Drift_Tool {
...
class LuwiPress_Sapphire_Legacy_Canvas_Tool {
...
class LuwiPress_Sapphire_Kit_CSS_Health_Tool {
...
class LuwiPress_Sapphire_Orphan_Media_Tool {
...
class LuwiPress_Sapphire_WPML_Structure_Sync_Tool {
...
class LuwiPress_Sapphire_Unwanted_Landing_Pages_Tool {
	...
	private static function commercial_keywords() {
		return apply_filters( 'luwipress_sapphire_unwanted_landing_keywords', array(
			// EN
...
class LuwiPress_Sapphire_Subcategory_Template_Parity_Tool {
...
class LuwiPress_Sapphire_Triangle_Health_Tool {
	...
	public static function scan( $args = array(), $tool = array() ) {
		...
		if ( ( $wpml || $polylang ) && class_exists( 'LuwiPress_Sapphire_WPML_Structure_Sync_Tool' ) ) {
			$wpml_audit = LuwiPress_Sapphire_WPML_Structure_Sync_Tool::scan( array(), array() );
		...
		if ( $wc && ( $wpml || $polylang ) && class_exists( 'LuwiPress_Sapphire_Subcategory_Template_Parity_Tool' ) ) {
			$subcat = LuwiPress_Sapphire_Subcategory_Template_Parity_Tool::scan( array(), array() );
		...
		if ( class_exists( 'LuwiPress_Sapphire_Unwanted_Landing_Pages_Tool' ) ) {
			$orphan = LuwiPress_Sapphire_Unwanted_Landing_Pages_Tool::scan( array(), array() );
