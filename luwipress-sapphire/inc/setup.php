...
add_action( 'after_setup_theme', function () {
	load_theme_textdomain( 'luwipress-sapphire', LUWIPRESS_SAPPHIRE_DIR . '/languages' );
	...
	register_nav_menus( [
		'primary'           => __( 'Primary navigation (header + drawer)', 'luwipress-sapphire' ),
		'mobile'            => __( 'Mobile drawer (header fallback)', 'luwipress-sapphire' ),
		'footer'            => __( 'Footer — Quick Links column', 'luwipress-sapphire' ),
		'footer-activities' => __( 'Footer — Explore column', 'luwipress-sapphire' ),
		'footer-legal'      => __( 'Footer — bottom-bar legal links', 'luwipress-sapphire' ),
	] );

	// Image sizes used inside Elementor Kit JSONs.
	add_image_size( 'luwipress-sapphire-card', 600, 600, true );
	add_image_size( 'luwipress-sapphire-cat',  600, 660, true );
	add_image_size( 'luwipress-sapphire-hero', 1100, 1100, false );
	add_image_size( 'luwipress-sapphire-editorial',      900, 720, true );
	add_image_size( 'luwipress-sapphire-editorial-feat', 1100, 880, true );
}, 5 );
