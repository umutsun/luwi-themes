...
if ( ! function_exists( 'luwipress_sapphire_wc_page_fallback' ) ) {
	 ...
	 * @return string
	 */
	function luwipress_sapphire_wc_page_fallback( $content ) {
	...
	add_filter( 'the_content', 'luwipress_sapphire_wc_page_fallback', 999 );
}
