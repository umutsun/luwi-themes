...
class LuwiPress_Sapphire_Widget_404_Hero extends Widget_Base {

	public function get_name()        { return 'lwp-404-hero'; }
	public function get_title()       { return __( '404 Hero', 'luwipress-sapphire' ); }
	...
	protected function register_controls() {
		...
		$this->add_control( 'big_number', [ 'label' => __( 'Big number', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => '404' ] );
		$this->add_control( 'eyebrow',    [ 'label' => __( 'Eyebrow', 'luwipress-sapphire' ),    'type' => Controls_Manager::TEXT, 'default' => __( 'Page not found', 'luwipress-sapphire' ) ] );
		$this->add_control(
			'heading',
			[
				'label'   => __( 'Heading', 'luwipress-sapphire' ),
				'description' => __( 'Use [em]…[/em] for italic-gold accent.', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::TEXTAREA,
				'rows'    => 2,
				'default' => __( 'This [em]tune[/em] is not in our songbook.', 'luwipress-sapphire' ),
			]
		);
		$this->add_control(
			'lead',
			[
				...
				'type'    => Controls_Manager::TEXTAREA,
				'rows'    => 3,
				'default' => __( "The link you followed may be broken — but the catalogue, the journal and the masters page are all just one click away.", 'luwipress-sapphire' ),
			]
		);
		$this->add_control( 'show_search', [ 'label' => __( 'Show search input', 'luwipress-sapphire' ), 'type' => Controls_Manager::SWITCHER, 'return_value' => 'yes', 'default' => 'yes' ] );
		$this->add_control(
			'search_placeholder',
			[ 'label' => __( 'Search placeholder', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => __( 'Search the site…', 'luwipress-sapphire' ),
				'condition' => [ 'show_search' => 'yes' ] ]
		);

		$this->add_control( 'cta1_label', [ 'label' => __( 'CTA 1 label', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => __( 'Browse the catalogue →', 'luwipress-sapphire' ) ] );
		$this->add_control( 'cta1_url',   [ 'label' => __( 'CTA 1 URL', 'luwipress-sapphire' ),   'type' => Controls_Manager::URL,  'default' => [ 'url' => '/shop' ] ] );
		$this->add_control( 'cta2_label', [ 'label' => __( 'CTA 2 label', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => __( 'Back home', 'luwipress-sapphire' ) ] );
		$this->add_control( 'cta2_url',   [ 'label' => __( 'CTA 2 URL', 'luwipress-sapphire' ),   'type' => Controls_Manager::URL,  'default' => [ 'url' => '/' ] ] );
		...
		$this->add_control( 'number_color', [ 'label' => __( 'Big number color', 'luwipress-sapphire' ), 'type' => Controls_Manager::COLOR, 'default' => '#9A7B3A',
			'selectors' => [ '{{WRAPPER}} .lwp-404__num' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'heading_color', [ 'label' => __( 'Heading color', 'luwipress-sapphire' ), 'type' => Controls_Manager::COLOR, 'default' => '#1A1612',
			'selectors' => [ '{{WRAPPER}} .lwp-404__title' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'em_color', [ 'label' => __( 'Italic accent color', 'luwipress-sapphire' ), 'type' => Controls_Manager::COLOR, 'default' => '#9A7B3A',
			'selectors' => [ '{{WRAPPER}} .lwp-404__title em' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'lead_color', [ 'label' => __( 'Lead color', 'luwipress-sapphire' ), 'type' => Controls_Manager::COLOR, 'default' => '#3a342c',
		...
		<div class="lwp-404">
			...
			<?php if ( $showS ) : ?>
				<form class="lwp-404__search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" role="search">
					...
					<button type="submit" aria-label="<?php esc_attr_e( 'Search', 'luwipress-sapphire' ); ?>">
