...
class LuwiPress_Sapphire_Widget_AI_Search extends Widget_Base {

	public function get_name()        { return 'lwp-ai-search'; }
	public function get_title()       { return __( 'AI Search Bar', 'luwipress-sapphire' ); }
	...
	protected function register_controls() {
		...
		$this->add_control( 'placeholder', [
			'label'   => __( 'Placeholder text', 'luwipress-sapphire' ),
			'type'    => Controls_Manager::TEXT,
			'default' => __( 'Search products, categories, posts…', 'luwipress-sapphire' ),
		] );

		$this->add_control( 'badge', [
			'label'       => __( 'Badge label', 'luwipress-sapphire' ),
			'description' => __( 'Small pill on the right side of the bar. Defaults to "AI" — only renders when LuwiPress AI is active.', 'luwipress-sapphire' ),
			'type'        => Controls_Manager::TEXT,
			'default'     => 'AI',
		] );

		$this->add_control( 'show_chips', [
			'label'        => __( 'Show suggestion chips', 'luwipress-sapphire' ),
			'description'  => __( 'Quick-tap suggested searches shown under the bar.', 'luwipress-sapphire' ),
		...
		$rep = new Repeater();
		$rep->add_control( 'label', [ 'label' => __( 'Chip label', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$rep->add_control( 'q',     [ 'label' => __( 'Search query', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );

		$this->add_control( 'chips', [
			'label'       => __( 'Chips', 'luwipress-sapphire' ),
			'type'        => Controls_Manager::REPEATER,
			'fields'      => $rep->get_controls(),
			'title_field' => '{{{ label || "Chip" }}}',
			'default'     => [
				[ 'label' => __( 'Best sellers', 'luwipress-sapphire' ), 'q' => '' ],
				[ 'label' => __( 'New arrivals', 'luwipress-sapphire' ), 'q' => '' ],
				[ 'label' => __( 'On sale',      'luwipress-sapphire' ), 'q' => '' ],
				[ 'label' => __( 'Gift ideas',   'luwipress-sapphire' ), 'q' => '' ],
			],
		...
		$this->add_control( 'size', [
			'label'   => __( 'Size', 'luwipress-sapphire' ),
			'type'    => Controls_Manager::SELECT,
			'default' => 'large',
			'options' => [
				'medium' => __( 'Medium', 'luwipress-sapphire' ),
				'large'  => __( 'Large (hero-style)', 'luwipress-sapphire' ),
			],
		] );
		$this->end_controls_section();
	}
	...
	protected function lp_ai_active() {
		return function_exists( 'lwp_sapphire_lp_active' ) && lwp_sapphire_lp_active();
	}
