...
class LuwiPress_Sapphire_Widget_CTA_Banner extends Widget_Base {

	public function get_name()        { return 'lwp-cta-banner'; }
	public function get_title()       { return __( 'CTA Banner', 'luwipress-sapphire' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_copy', [ 'label' => __( 'Copy', 'luwipress-sapphire' ) ] );

		$this->add_control( 'eyebrow', [ 'label' => __( 'Eyebrow', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$this->add_control( 'heading', [
			'label'       => __( 'Headline', 'luwipress-sapphire' ),
			'description' => __( 'Use Enter for line breaks. Wrap with [em]…[/em] for italic gold accent.', 'luwipress-sapphire' ),
			'type'        => Controls_Manager::TEXTAREA,
			'rows'        => 3,
			'default'     => __( 'Build the instrument you have always wanted.', 'luwipress-sapphire' ),
		] );
		$this->add_control( 'lead', [ 'label' => __( 'Lead', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXTAREA, 'rows' => 3, 'default' => '' ] );

		$this->add_control( 'cta1_label', [ 'label' => __( 'Primary CTA — label', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => __( 'Start a custom order →', 'luwipress-sapphire' ) ] );
		$this->add_control( 'cta1_url',   [ 'label' => __( 'Primary CTA — URL', 'luwipress-sapphire' ),   'type' => Controls_Manager::URL,  'default' => [ 'url' => '' ] ] );
		$this->add_control( 'cta2_label', [ 'label' => __( 'Secondary CTA — label', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$this->add_control( 'cta2_url',   [ 'label' => __( 'Secondary CTA — URL', 'luwipress-sapphire' ),   'type' => Controls_Manager::URL,  'default' => [ 'url' => '' ] ] );

		$this->end_controls_section();

		$this->start_controls_section( 'section_bg', [ 'label' => __( 'Background', 'luwipress-sapphire' ) ] );

		$this->add_control( 'bg_image', [
			'label' => __( 'Background image (optional)', 'luwipress-sapphire' ),
			'type'  => Controls_Manager::MEDIA,
			'default' => [ 'url' => '' ],
		] );
		$this->add_control( 'bg_grad_from', [ 'label' => __( 'Gradient start', 'luwipress-sapphire' ), 'type' => Controls_Manager::COLOR, 'default' => '#1A1612' ] );
		$this->add_control( 'bg_grad_to',   [ 'label' => __( 'Gradient end', 'luwipress-sapphire' ),   'type' => Controls_Manager::COLOR, 'default' => '#3d2f1f' ] );

		$this->add_control( 'overlay', [
			'label' => __( 'Image overlay strength', 'luwipress-sapphire' ),
			'description' => __( 'Only applies when a background image is set.', 'luwipress-sapphire' ),
			'type'  => Controls_Manager::SELECT,
			'default' => 'medium',
			'options' => [
				'none'    => __( 'None', 'luwipress-sapphire' ),
				'light'   => __( 'Light', 'luwipress-sapphire' ),
				'medium'  => __( 'Medium', 'luwipress-sapphire' ),
				'strong'  => __( 'Strong', 'luwipress-sapphire' ),
			],
		] );

		$this->add_control( 'align', [
			'label' => __( 'Content alignment', 'luwipress-sapphire' ),
			'type'  => Controls_Manager::SELECT,
			'default' => 'center',
			'options' => [
				'left'   => __( 'Left', 'luwipress-sapphire' ),
				'center' => __( 'Center', 'luwipress-sapphire' ),
				'right'  => __( 'Right', 'luwipress-sapphire' ),
			],
		] );
