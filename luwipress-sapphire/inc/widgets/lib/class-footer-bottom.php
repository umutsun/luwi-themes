...
class LuwiPress_Sapphire_Widget_Footer_Bottom extends Widget_Base {

	public function get_name()        { return 'lwp-footer-bottom'; }
	public function get_title()       { return __( 'Footer Bottom', 'luwipress-sapphire' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_left', [ 'label' => __( 'Copyright + Legal', 'luwipress-sapphire' ) ] );

		$this->add_control(
			'copyright',
			[
				'label'   => __( 'Copyright line', 'luwipress-sapphire' ),
				'description' => __( 'Use %YEAR% to insert the current year automatically.', 'luwipress-sapphire' ),
		...
		$rep = new Repeater();
		$rep->add_control( 'label', [ 'label' => __( 'Label', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => 'Privacy' ] );
		$rep->add_control( 'url',   [ 'label' => __( 'URL', 'luwipress-sapphire' ),   'type' => Controls_Manager::URL,  'default' => [ 'url' => '#' ] ] );

		$this->add_control(
			'legal_links',
			[
				'label'       => __( 'Legal links', 'luwipress-sapphire' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $rep->get_controls(),
				'title_field' => '{{{ label || "Link" }}}',
				'default'     => [
					[ 'label' => __( 'Privacy', 'luwipress-sapphire' ), 'url' => [ 'url' => '/privacy' ] ],
					[ 'label' => __( 'Terms', 'luwipress-sapphire' ),   'url' => [ 'url' => '/terms' ] ],
					[ 'label' => __( 'Cookies', 'luwipress-sapphire' ), 'url' => [ 'url' => '/cookies' ] ],
				],
			]
		);
		...
		/* Payment methods */
		$this->start_controls_section( 'section_pay', [ 'label' => __( 'Payment methods', 'luwipress-sapphire' ) ] );

		$this->add_control(
			'pay_label',
			[
				'label'   => __( 'Payment label', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Secure payments', 'luwipress-sapphire' ),
			]
		);

		$rep_pay = new Repeater();
		$rep_pay->add_control( 'label', [ 'label' => __( 'Method', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => 'VISA' ] );

		$this->add_control(
			'pay_methods',
			[
				'label'       => __( 'Methods', 'luwipress-sapphire' ),
				'type'        => Controls_Manager::REPEATER,
		...
		$this->add_control(
			'link_hover_color',
			[
				'label'   => __( 'Link hover color', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#D4AF37',
		...
		$this->add_control(
			'pay_bg',
			[
				'label'   => __( 'Pay badge bg', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#1A1612',
		...
		$this->add_control(
			'pay_border',
			[
				'label'   => __( 'Pay badge border', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#3a342c',
