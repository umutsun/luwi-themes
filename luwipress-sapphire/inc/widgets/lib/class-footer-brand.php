...
class LuwiPress_Sapphire_Widget_Footer_Brand extends Widget_Base {

	public function get_name()        { return 'lwp-footer-brand'; }
	public function get_title()       { return __( 'Footer Brand', 'luwipress-sapphire' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_logo', [ 'label' => __( 'Logo', 'luwipress-sapphire' ) ] );

		$this->add_control(
			'logo_image',
			[
				'label'   => __( 'Logo image (optional)', 'luwipress-sapphire' ),
				'description' => __( 'If set, replaces the text logo.', 'luwipress-sapphire' ),
		...
		$this->add_control(
			'logo_text',
			[
				'label'   => __( 'Logo text', 'luwipress-sapphire' ),
		...
		$this->add_control(
			'accent_index',
			[
				'label'   => __( 'Accent character position (0-indexed)', 'luwipress-sapphire' ),
				'description' => __( 'Which character to italicise + accent-tint. -1 = none.', 'luwipress-sapphire' ),
		...
		$this->add_control(
			'logo_url',
			[
				'label'   => __( 'Logo link', 'luwipress-sapphire' ),
		...
		/* Tagline */
		$this->start_controls_section( 'section_tag', [ 'label' => __( 'Tagline', 'luwipress-sapphire' ) ] );
		$this->add_control(
			'tagline',
			[
				'label'   => __( 'Tagline / description', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::TEXTAREA,
				'rows'    => 3,
				'default' => __( 'A short brand line that explains what your store does and where you ship from.', 'luwipress-sapphire' ),
			]
		);
		$this->end_controls_section();

		/* Contact */
		$this->start_controls_section( 'section_contact', [ 'label' => __( 'Contact', 'luwipress-sapphire' ) ] );
		$this->add_control( 'phone',   [ 'label' => __( 'Phone', 'luwipress-sapphire' ),   'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$this->add_control( 'email',   [ 'label' => __( 'Email', 'luwipress-sapphire' ),   'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$this->add_control( 'address', [ 'label' => __( 'Address line', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$this->end_controls_section();

		/* Social */
		$this->start_controls_section( 'section_social', [ 'label' => __( 'Social icons', 'luwipress-sapphire' ) ] );

		$rep = new Repeater();
		$rep->add_control(
			'network',
			[
				'label'   => __( 'Network', 'luwipress-sapphire' ),
		...
		$rep->add_control(
			'url',
			[ 'label' => __( 'URL', 'luwipress-sapphire' ), 'type' => Controls_Manager::URL, 'default' => [ 'url' => '#' ] ]
		);

		$this->add_control(
			'socials',
			[
				'label'       => __( 'Social links', 'luwipress-sapphire' ),
		...
		$this->add_control(
			'logo_color',
			[
				'label'   => __( 'Logo color', 'luwipress-sapphire' ),
		...
		$this->add_control(
			'accent_color',
			[
				'label'   => __( 'Accent color', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#D4AF37',
		...
		$this->add_control(
			'text_color',
			[
				'label'   => __( 'Text color', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#a89d85',
