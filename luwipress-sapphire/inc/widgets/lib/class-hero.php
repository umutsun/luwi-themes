...
class LuwiPress_Sapphire_Widget_Hero extends Widget_Base {

	public function get_name()        { return 'lwp-hero'; }
	public function get_title()       { return __( 'Hero', 'luwipress-sapphire' ); }
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'split',
				'options' => [
					'split'      => __( 'Split (text + visual side-by-side)', 'luwipress-sapphire' ),
					'centered'   => __( 'Centered (headline above image)', 'luwipress-sapphire' ),
					'full-bleed' => __( 'Full-bleed (image cover + text overlay)', 'luwipress-sapphire' ),
				],
			]
		);
		...
		/* Content */
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Content', 'luwipress-sapphire' ) ] );
		$this->add_control(
			'eyebrow',
			[
				'label'   => __( 'Eyebrow', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Welcome · Worldwide shipping', 'luwipress-sapphire' ),
			]
		);
		$this->add_control(
			'headline',
			[
				'label'       => __( 'Headline (HTML allowed)', 'luwipress-sapphire' ),
				'type'        => Controls_Manager::TEXTAREA,
				'rows'        => 3,
				'default'     => __( 'Your headline<br>in <em>two lines</em> with a <span class="underline">highlighted phrase</span>.', 'luwipress-sapphire' ),
				'description' => __( 'Use <em>…</em> for italic emphasis (gold) and <span class="underline">…</span> for the underline accent.', 'luwipress-sapphire' ),
			]
		);
		$this->add_control(
			'lead',
			[
				'label'   => __( 'Lead paragraph', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::TEXTAREA,
				'rows'    => 3,
				'default' => __( 'A short paragraph explaining who you are and what you make. Replace this copy from the widget editor.', 'luwipress-sapphire' ),
			]
		);
		...
		$this->add_control(
			'cta_primary_label',
			[
				'label'   => __( 'Primary CTA — label', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Explore the collection', 'luwipress-sapphire' ),
			]
		);
		$this->add_control(
			'cta_primary_url',
			[
				'label'   => __( 'Primary CTA — URL', 'luwipress-sapphire' ),
		...
		$this->add_control(
			'cta_secondary_label',
			[
				'label'   => __( 'Secondary CTA — label', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Learn more', 'luwipress-sapphire' ),
			]
		);
		$this->add_control(
			'cta_secondary_url',
			[
				'label'   => __( 'Secondary CTA — URL', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::URL,
				'default' => [ 'url' => '' ],
			]
		);
		...
		$this->add_control(
			'image',
			[
				'label'       => __( 'Visual', 'luwipress-sapphire' ),
				'type'        => Controls_Manager::MEDIA,
				'default'     => [ 'url' => '' ],
				'description' => __( 'Used in split + centered + full-bleed variants. Falls back to a gradient.', 'luwipress-sapphire' ),
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section( 'section_stats', [
			'label' => __( 'Stats', 'luwipress-sapphire' ),
			'condition' => [ 'variant' => [ 'split', 'centered' ] ],
		] );
		$this->add_control(
			'show_stats',
			[
				'label'   => __( 'Show stats row', 'luwipress-sapphire' ),
		...
		$repeater->add_control(
			'value',
			[ 'label' => __( 'Value', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => '1,200+' ]
		);
		$repeater->add_control(
			'label',
			[ 'label' => __( 'Label', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => 'Instruments' ]
		);
		$this->add_control(
			'stats',
			[
				'label'       => __( 'Stat cards', 'luwipress-sapphire' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $repeater->get_controls(),
				'title_field' => '{{{ value }}} — {{{ label }}}',
				'default'     => [
					[ 'value' => '1,200+', 'label' => __( 'Instruments', 'luwipress-sapphire' ) ],
					[ 'value' => '28',     'label' => __( 'Master makers', 'luwipress-sapphire' ) ],
					[ 'value' => '47',     'label' => __( 'Countries shipped', 'luwipress-sapphire' ) ],
				],
		...
		$this->start_controls_section( 'section_master', [
			'label'     => __( 'Master overlay', 'luwipress-sapphire' ),
			'condition' => [ 'variant' => [ 'split', 'full-bleed' ] ],
		] );
		$this->add_control(
			'master_avatar',
			[
				'label'       => __( 'Master avatar', 'luwipress-sapphire' ),
				'type'        => Controls_Manager::MEDIA,
				'default'     => [ 'url' => '' ],
				'description' => __( 'Square portrait — anything from 96×96 up. Empty to disable the overlay.', 'luwipress-sapphire' ),
			]
		);
		$this->add_control(
			'master_name',
			[
				'label'   => __( 'Master name', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Yıldırım Palabıyık', 'luwipress-sapphire' ),
			]
		);
		$this->add_control(
			'master_role',
			[
				'label'   => __( 'Master role', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Role · Location', 'luwipress-sapphire' ),
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			'overlay_color',
			[
				'label'     => __( 'Image overlay (full-bleed only)', 'luwipress-sapphire' ),
