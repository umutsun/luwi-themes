...
class LuwiPress_Sapphire_Widget_Info_Bar extends Widget_Base {

	public function get_name()        { return 'lwp-info-bar'; }
	public function get_title()       { return __( 'Info Bar', 'luwipress-sapphire' ); }
	...
	protected function register_controls() {
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Items', 'luwipress-sapphire' ) ] );

		$repeater = new Repeater();
		$repeater->add_control(
			'icon',
			[
				'label'   => __( 'Icon', 'luwipress-sapphire' ),
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'Free shipping', 'luwipress-sapphire' ),
			]
		);
		$repeater->add_control(
			'desc',
			[
				'label'   => __( 'Description', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Worldwide · DHL Express', 'luwipress-sapphire' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'title_field' => '{{{ title }}}',
				'default'     => [
					[ 'title' => __( 'Free shipping', 'luwipress-sapphire' ),    'desc' => __( 'Worldwide · DHL Express', 'luwipress-sapphire' ),    'icon' => [ 'value' => 'fas fa-shipping-fast', 'library' => 'fa-solid' ] ],
					[ 'title' => __( '15-day warranty', 'luwipress-sapphire' ), 'desc' => __( 'Easy returns, no questions', 'luwipress-sapphire' ), 'icon' => [ 'value' => 'fas fa-undo-alt',     'library' => 'fa-solid' ] ],
					[ 'title' => __( 'Hand-tuned', 'luwipress-sapphire' ),       'desc' => __( 'Before every shipment', 'luwipress-sapphire' ),     'icon' => [ 'value' => 'fas fa-music',        'library' => 'fa-solid' ] ],
					[ 'title' => __( '100% secure', 'luwipress-sapphire' ),     'desc' => __( 'Trusted checkout', 'luwipress-sapphire' ),           'icon' => [ 'value' => 'fas fa-lock',         'library' => 'fa-solid' ] ],
				],
			]
		);
		...
		$this->add_control(
			'bar_bg',
			[
				'label'     => __( 'Bar background', 'luwipress-sapphire' ),
		...
		$this->add_control(
			'icon_bg',
			[
				'label'       => __( 'Icon circle background', 'luwipress-sapphire' ),
				'description' => __( 'Pick a flat color. Leave empty to keep the theme default (gradient gold).', 'luwipress-sapphire' ),
				'type'        => Controls_Manager::COLOR,
				'default'     => '',
		...
		$this->add_control(
			'desc_color',
			[
				'label'     => __( 'Description color', 'luwipress-sapphire' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#9b9285',
