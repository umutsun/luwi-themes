...
class LuwiPress_Sapphire_Widget_Load_More extends Widget_Base {

	public function get_name()        { return 'lwp-load-more'; }
	public function get_title()       { return __( 'Load More', 'luwipress-sapphire' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Button', 'luwipress-sapphire' ) ] );
		...
		$this->add_control(
			...
			[
				...
				'default' => 'link',
				'options' => [
					'link' => __( 'Plain link (SEO-friendly)', 'luwipress-sapphire' ),
					'ajax' => __( 'AJAX (in-place append)', 'luwipress-sapphire' ),
				],
			]
		);
		$this->add_control(
			'label_template',
			[
				'label'   => __( 'Label', 'luwipress-sapphire' ),
				'description' => __( 'Use %d for remaining count placeholder.', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Load %d more posts', 'luwipress-sapphire' ),
			]
		);
		$this->add_control(
			'target_selector',
			[
				'label'   => __( 'Target container (AJAX mode)', 'luwipress-sapphire' ),
				'description' => __( 'Where to append new posts. Default catches WC / WP loops.', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::TEXT,
		...
		$this->add_control(
			'hide_when_done',
			[
				'label'        => __( 'Hide when no more pages', 'luwipress-sapphire' ),
		...
		$this->add_control( 'text_color', [ 'label' => __( 'Text color', 'luwipress-sapphire' ), 'type' => Controls_Manager::COLOR, 'default' => '#1A1612',
			'selectors' => [ '{{WRAPPER}} .lwp-lm__btn' => 'color: {{VALUE}}; border-color: {{VALUE}};' ] ] );
		$this->add_control( 'bg_hover', [ 'label' => __( 'Hover background', 'luwipress-sapphire' ), 'type' => Controls_Manager::COLOR, 'default' => '#1A1612',
