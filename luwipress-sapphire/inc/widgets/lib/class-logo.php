...
class LuwiPress_Sapphire_Widget_Logo extends Widget_Base {

	public function get_name()        { return 'lwp-logo'; }
	public function get_title()       { return __( 'Logo', 'luwipress-sapphire' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Logo', 'luwipress-sapphire' ) ] );

		$this->add_control(
			'image',
			[
				'label'   => __( 'Image (optional)', 'luwipress-sapphire' ),
				'description' => __( 'When set, replaces the text wordmark.', 'luwipress-sapphire' ),
		...
		$this->add_control(
			'image_max_height',
			[
				'label'   => __( 'Image max height', 'luwipress-sapphire' ),
		...
		$this->add_control(
			'text',
			[
				'label'   => __( 'Text wordmark', 'luwipress-sapphire' ),
		...
		$this->add_control(
			'accent_index',
			[
				'label'   => __( 'Accent character index (0-based, -1 = none)', 'luwipress-sapphire' ),
		...
		$this->add_control(
			'link_url',
			[
				'label'   => __( 'Link URL', 'luwipress-sapphire' ),
		...
		$this->add_control(
			'accent_hover_color',
			[
				'label'   => __( 'Accent hover color', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#D4AF37',
