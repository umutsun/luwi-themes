...
class LuwiPress_Sapphire_Widget_Perks_List extends Widget_Base {

	public function get_name()        { return 'lwp-perks-list'; }
	public function get_title()       { return __( 'Perks List', 'luwipress-sapphire' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Perks', 'luwipress-sapphire' ) ] );

		$rep = new Repeater();
		$rep->add_control(
			'icon_type',
			[
				'label'   => __( 'Icon style', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'check',
				'options' => [
					'check'    => __( 'Check', 'luwipress-sapphire' ),
					'truck'    => __( 'Truck', 'luwipress-sapphire' ),
					'shield'   => __( 'Shield', 'luwipress-sapphire' ),
					'tool'     => __( 'Tool', 'luwipress-sapphire' ),
					'star'     => __( 'Star', 'luwipress-sapphire' ),
					'heart'    => __( 'Heart', 'luwipress-sapphire' ),
					'leaf'     => __( 'Leaf', 'luwipress-sapphire' ),
					'gift'     => __( 'Gift', 'luwipress-sapphire' ),
					'phone'    => __( 'Phone', 'luwipress-sapphire' ),
				],
			]
		);
		$rep->add_control( 'strong', [ 'label' => __( 'Bold lead', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => 'Hand-tuned' ] );
		$rep->add_control( 'body',   [ 'label' => __( 'Body', 'luwipress-sapphire' ),     'type' => Controls_Manager::TEXT, 'default' => 'in our atelier before shipping' ] );

		$this->add_control(
			'perks',
			[
				'label'       => __( 'Perks', 'luwipress-sapphire' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $rep->get_controls(),
				'title_field' => '{{{ strong || "Perk" }}}',
				'default'     => [
					[ 'icon_type' => 'check',  'strong' => __( 'Hand-tuned', 'luwipress-sapphire' ),     'body' => __( 'in our atelier before shipping', 'luwipress-sapphire' ) ],
					[ 'icon_type' => 'truck',  'strong' => __( 'Free DHL shipping', 'luwipress-sapphire' ), 'body' => __( 'on orders over €450', 'luwipress-sapphire' ) ],
					[ 'icon_type' => 'shield', 'strong' => __( '2-year warranty', 'luwipress-sapphire' ), 'body' => __( '+ lifetime tuning support', 'luwipress-sapphire' ) ],
				],
			]
		);
		...
		$this->add_control( 'icon_color',   [ 'label' => __( 'Icon color', 'luwipress-sapphire' ),   'type' => Controls_Manager::COLOR, 'default' => '#9A7B3A',
			'selectors' => [ '{{WRAPPER}} .lwp-perks__icon' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'strong_color', [ 'label' => __( 'Bold color', 'luwipress-sapphire' ),   'type' => Controls_Manager::COLOR, 'default' => '#1A1612',
			'selectors' => [ '{{WRAPPER}} .lwp-perks__strong' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'body_color',   [ 'label' => __( 'Body color', 'luwipress-sapphire' ),   'type' => Controls_Manager::COLOR, 'default' => '#3a342c',
