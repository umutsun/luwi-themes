...
class LuwiPress_Sapphire_Widget_Post_Title extends Widget_Base {

	public function get_name()        { return 'lwp-post-title'; }
	public function get_title()       { return __( 'Post Title', 'luwipress-sapphire' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Title', 'luwipress-sapphire' ) ] );

		$this->add_control(
			'tag',
			[
				'label'   => __( 'HTML tag', 'luwipress-sapphire' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'justify' => [ 'title' => __( 'Justify', 'luwipress-sapphire' ),'icon' => 'eicon-text-align-justify' ],
				],
		...
		$this->add_control(
			'color',
			[
				'label'     => __( 'Color', 'luwipress-sapphire' ),
		...
		$this->add_responsive_control(
			'margin',
			[
				'label'      => __( 'Margin', 'luwipress-sapphire' ),
	...
	protected function render() {
		...
		if ( ! $post ) {
			...
			echo '<' . esc_attr( $tag ) . ' class="lwp-post-title">' . esc_html__( 'Post Title', 'luwipress-sapphire' ) . '</' . esc_attr( $tag ) . '>';
			return;
		}
