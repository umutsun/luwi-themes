...
class LuwiPress_Sapphire_Widget_Section_Head extends Widget_Base {

	public function get_name()        { return 'lwp-section-head'; }
	public function get_title()       { return __( 'Section Head', 'luwipress-sapphire' ); }
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'Use Enter for a multi-line title. Wrap a phrase with [em]…[/em] to italicise + gold-tint it.', 'luwipress-sapphire' ),
		...
		$this->add_control(
			'heading_tag',
			[
				'label'   => __( 'Heading tag', 'luwipress-sapphire' ),
		...
		$this->start_controls_section( 'section_pills', [ 'label' => __( 'Pill tabs (optional)', 'luwipress-sapphire' ) ] );

		$rep = new Repeater();
		$rep->add_control(
			'label',
			[ 'label' => __( 'Label', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => '' ]
		);
		$rep->add_control(
			'url',
		...
		$rep->add_control(
			'active',
			[
				'label'        => __( 'Mark as active', 'luwipress-sapphire' ),
		...
		$this->add_control(
			'pills',
			[
				'label'       => __( 'Pills', 'luwipress-sapphire' ),
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'Light = dark text on light bg. Dark = light text on dark bg (e.g. for the masters section).', 'luwipress-sapphire' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'light',
				'options' => [
					'light' => __( 'Light', 'luwipress-sapphire' ),
					'dark'  => __( 'Dark', 'luwipress-sapphire' ),
				],
			]
		);
		$this->end_controls_section();
