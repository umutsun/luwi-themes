...
class LuwiPress_Sapphire_Widget_Shop_Filters extends Widget_Base {

	public function get_name()        { return 'lwp-shop-filters'; }
	public function get_title()       { return __( 'Shop Filters', 'luwipress-sapphire' ); }
	...
	protected function register_controls() {
		...
		/* Auto blocks */
		$this->start_controls_section( 'section_auto', [ 'label' => __( 'Auto blocks (WC)', 'luwipress-sapphire' ) ] );

		$this->add_control( 'show_category', [
			'label'        => __( 'Show category facet', 'luwipress-sapphire' ),
			'type'         => Controls_Manager::SWITCHER,
			'return_value' => 'yes',
			'default'      => 'yes',
		] );
		$this->add_control( 'label_category', [
			'label'   => __( 'Category facet label', 'luwipress-sapphire' ),
			'type'    => Controls_Manager::TEXT,
			'default' => __( 'Family', 'luwipress-sapphire' ),
			'condition' => [ 'show_category' => 'yes' ],
		] );

		$this->add_control( 'show_price', [
			'label'        => __( 'Show price range', 'luwipress-sapphire' ),
			'type'         => Controls_Manager::SWITCHER,
			'return_value' => 'yes',
			'default'      => 'yes',
		] );
		$this->add_control( 'label_price', [
			'label'   => __( 'Price facet label', 'luwipress-sapphire' ),
			'type'    => Controls_Manager::TEXT,
			'default' => __( 'Price', 'luwipress-sapphire' ),
			'condition' => [ 'show_price' => 'yes' ],
		] );

		$this->add_control( 'show_stock', [
			'label'        => __( 'Show availability', 'luwipress-sapphire' ),
			'type'         => Controls_Manager::SWITCHER,
			'return_value' => 'yes',
			'default'      => 'yes',
		] );
		$this->add_control( 'label_stock', [
			'label'   => __( 'Availability facet label', 'luwipress-sapphire' ),
			'type'    => Controls_Manager::TEXT,
			'default' => __( 'Availability', 'luwipress-sapphire' ),
		...
		/* Manual blocks */
		$this->start_controls_section( 'section_manual', [ 'label' => __( 'Custom blocks', 'luwipress-sapphire' ) ] );

		$item_rep = new Repeater();
		$item_rep->add_control( 'label', [ 'label' => __( 'Label', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => 'Option' ] );
		$item_rep->add_control( 'count', [ 'label' => __( 'Count', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$item_rep->add_control( 'value', [ 'label' => __( 'Value (URL param)', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );

		$block_rep = new Repeater();
		$block_rep->add_control( 'heading', [ 'label' => __( 'Block heading', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => 'Master luthier' ] );
		$block_rep->add_control( 'param',   [ 'label' => __( 'Query parameter', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => 'master' ] );
		$block_rep->add_control(
			'items',
			[
				'label' => __( 'Items', 'luwipress-sapphire' ),
		...
		$this->add_control(
			'custom_blocks',
			[
				'label'       => __( 'Custom filter blocks', 'luwipress-sapphire' ),
				'type'        => Controls_Manager::REPEATER,
		...
		$this->add_control(
			'apply_label',
			[ 'label' => __( 'Apply button label', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => __( 'Apply filters', 'luwipress-sapphire' ) ]
		);
		$this->add_control(
			'clear_label',
			[ 'label' => __( 'Clear button label', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => __( 'Clear all', 'luwipress-sapphire' ) ]
		);
		...
		$this->add_control( 'heading_color', [ 'label' => __( 'Block heading color', 'luwipress-sapphire' ), 'type' => Controls_Manager::COLOR, 'default' => '#1A1612',
			'selectors' => [ '{{WRAPPER}} .lwp-sf__heading' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'item_color', [ 'label' => __( 'Item color', 'luwipress-sapphire' ), 'type' => Controls_Manager::COLOR, 'default' => '#3a342c',
			'selectors' => [ '{{WRAPPER}} .lwp-sf__item' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'count_color', [ 'label' => __( 'Count color', 'luwipress-sapphire' ), 'type' => Controls_Manager::COLOR, 'default' => '#8b7f6a',
			'selectors' => [ '{{WRAPPER}} .lwp-sf__count' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'accent_color', [ 'label' => __( 'Accent', 'luwipress-sapphire' ), 'type' => Controls_Manager::COLOR, 'default' => '#1A1612',
			'selectors' => [
		...
		<aside class="lwp-sf">
			<form class="lwp-sf__form" method="get" action="<?php echo esc_url( $action ); ?>">
				...
				if ( $show_stock ) :
					...
					$opts = [
						'instock'    => __( 'In stock', 'luwipress-sapphire' ),
						'onbackorder'=> __( 'Pre-order', 'luwipress-sapphire' ),
						'outofstock' => __( 'Made to order', 'luwipress-sapphire' ),
					];
					?>
					<div class="lwp-sf__block">
