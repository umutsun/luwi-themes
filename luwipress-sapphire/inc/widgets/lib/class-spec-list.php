...
class LuwiPress_Sapphire_Widget_Spec_List extends Widget_Base {

	public function get_name()        { return 'lwp-spec-list'; }
	public function get_title()       { return __( 'Spec List', 'luwipress-sapphire' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Specs', 'luwipress-sapphire' ) ] );
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'attributes' => __( 'Auto: current product attributes (WC)', 'luwipress-sapphire' ),
				],
			]
		);

		$rep = new Repeater();
		$rep->add_control( 'label', [ 'label' => __( 'Label', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => 'Material' ] );
		$rep->add_control( 'value', [ 'label' => __( 'Value', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => 'Walnut' ] );

		$this->add_control(
			'rows',
			[
				'label'       => __( 'Rows', 'luwipress-sapphire' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $rep->get_controls(),
				'title_field' => '{{{ label || "Row" }}}',
				'default'     => [
					[ 'label' => __( 'Material', 'luwipress-sapphire' ), 'value' => 'Walnut' ],
					[ 'label' => __( 'Weight', 'luwipress-sapphire' ),   'value' => '1.4 kg' ],
				],
		...
		$this->add_control(
			...
			[
				...
				'type'    => Controls_Manager::SELECT,
				'default' => '1',
				'options' => [ '1' => __( 'Single column', 'luwipress-sapphire' ), '2' => __( 'Two columns', 'luwipress-sapphire' ) ],
			]
		);
		...
		$this->add_control( 'label_color', [ 'label' => __( 'Label color', 'luwipress-sapphire' ), 'type' => Controls_Manager::COLOR, 'default' => '#8b7f6a',
			'selectors' => [ '{{WRAPPER}} .lwp-spec dt' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'value_color', [ 'label' => __( 'Value color', 'luwipress-sapphire' ), 'type' => Controls_Manager::COLOR, 'default' => '#1A1612',
			'selectors' => [ '{{WRAPPER}} .lwp-spec dd' => 'color: {{VALUE}};' ] ] );
		$this->add_control( 'border_color', [ 'label' => __( 'Row border', 'luwipress-sapphire' ), 'type' => Controls_Manager::COLOR, 'default' => '#eae3d4',
