...
class LuwiPress_Sapphire_Widget_Stat_Counter extends Widget_Base {

	public function get_name()        { return 'lwp-stat-counter'; }
	public function get_title()       { return __( 'Stat Counter', 'luwipress-sapphire' ); }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_items', [ 'label' => __( 'Stats', 'luwipress-sapphire' ) ] );

		$rep = new Repeater();
		$rep->add_control( 'number', [ 'label' => __( 'Number', 'luwipress-sapphire' ), 'type' => Controls_Manager::NUMBER, 'default' => 240 ] );
		$rep->add_control( 'prefix', [ 'label' => __( 'Prefix (e.g. €)', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$rep->add_control( 'suffix', [ 'label' => __( 'Suffix (e.g. + or k)', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => '+' ] );
		$rep->add_control( 'label',  [ 'label' => __( 'Label', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => __( 'Products in catalogue', 'luwipress-sapphire' ) ] );
		$rep->add_control( 'sub',    [ 'label' => __( 'Sub line (optional)', 'luwipress-sapphire' ), 'type' => Controls_Manager::TEXT, 'default' => '' ] );
		$rep->add_control( 'icon',   [ 'label' => __( 'Icon (optional)', 'luwipress-sapphire' ), 'type' => Controls_Manager::ICONS, 'default' => [ 'value' => '', 'library' => '' ] ] );
		...
		$this->add_control( 'items', [
			...
			'default'     => [
				[ 'number' => 100, 'suffix' => '+',   'label' => __( 'Products', 'luwipress-sapphire' ) ],
				[ 'number' => 10,  'suffix' => '',    'label' => __( 'Countries shipped', 'luwipress-sapphire' ) ],
				[ 'number' => 5,   'suffix' => '',    'label' => __( 'Team members', 'luwipress-sapphire' ) ],
				[ 'number' => 3,   'suffix' => ' yrs', 'label' => __( 'In business', 'luwipress-sapphire' ) ],
			],
		] );
		...
		$this->add_control( 'duration', [
			'label'   => __( 'Count-up duration (ms)', 'luwipress-sapphire' ),
		...
		$this->add_control( 'show_dividers', [
			'label'        => __( 'Vertical dividers', 'luwipress-sapphire' ),
