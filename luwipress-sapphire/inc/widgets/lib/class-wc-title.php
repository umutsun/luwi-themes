...
class LuwiPress_Sapphire_Widget_WC_Title extends Widget_Base {

	public function get_name()        { return 'lwp-wc-title'; }
	public function get_title()       { return __( 'WC Product Title', 'luwipress-sapphire' ); }
	...
	protected function register_controls() {
		...
		$this->add_control( 'link_to', [
			'label'   => __( 'Link to product page', 'luwipress-sapphire' ),
		...
		$this->add_control( 'color', [
			'label' => __( 'Color', 'luwipress-sapphire' ), 'type' => Controls_Manager::COLOR, 'default' => '#1A1612',
	...
	protected function render() {
		...
		if ( ! $product ) {
			echo '<' . esc_attr( $tag ) . ' class="lwp-wc-title">' . esc_html__( 'Product Title', 'luwipress-sapphire' ) . '</' . esc_attr( $tag ) . '>';
			return;
		}
