<?php
/**
 * Generic page — Sapphire editorial reading column. Elementor-built pages
	...
	<main>
		<section class="phead">
			<div class="wrap" style="max-width:820px">
				<div class="crumb"><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'Home', 'luwipress-sapphire' ); ?></a><span class="sep">/</span><span><?php the_title(); ?></span></div>
			...
			<div class="wrap">
				<article class="article">
					...
					if ( has_post_thumbnail() ) {
						echo sapphire_ph( array( 'img' => get_the_post_thumbnail_url( get_the_ID(), 'full' ), 'alt' => get_the_title(), 'class' => 'a-hero' ) ); // phpcs:ignore
					}
					the_content();
