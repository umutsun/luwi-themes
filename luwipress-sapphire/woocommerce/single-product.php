...
<main class="lwp-pdp" id="primary">
	<div class="lwp-pdp-container">
		...
		<?php while ( have_posts() ) : the_post();
			...
			$perks = apply_filters( 'luwipress_sapphire_pdp_perks', [
				[ 'icon' => '✓', 'text' => __( 'Hand-tuned in our atelier before dispatch', 'luwipress-sapphire' ) ],
				[ 'icon' => '✈', 'text' => __( 'DHL Express worldwide · 3–7 working days', 'luwipress-sapphire' ) ],
				[ 'icon' => '↺', 'text' => __( '14-day no-questions-asked return policy', 'luwipress-sapphire' ) ],
				[ 'icon' => '★', 'text' => __( '2-year free service & tuning warranty', 'luwipress-sapphire' ) ],
